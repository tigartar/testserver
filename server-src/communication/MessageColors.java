...
public final class MessageColors {
    ...
    public static final byte COLOR_ENCHANT_NAME_ID = 16;
    public static final byte COLOR_ENCHANT_DESC_ID = 17;
    public static final byte COLOR_ENCHANT_POWER_ID = 18;
    public static final byte COLOR_ACID_ID = 19;
    public static final byte COLOR_FIRE_ID = 20;
    public static final byte COLOR_FROST_ID = 21;
