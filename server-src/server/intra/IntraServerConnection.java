...
public final class IntraServerConnection implements SimpleConnectionListener, MiscConstants, TimeConstants {
   ...
   public void reallyHandle(int num, ByteBuffer byteBuffer) {
      ...
      if (cmd == 1) {
         ...
         } catch (NoSuchPlayerException var52) {
            try {
         ...
         } catch (NoSuchPlayerException var47) {
            try {
         ...
         boolean surfaced = byteBuffer.get() != 0;
         if (this.unpackPlayerData(posx, posy, surfaced)) {
            try {
               ...
               try {
                  logger.log(Level.WARNING, "Failed to receive user: " + ex.getMessage(), (Throwable)ex);
                  this.sendCommandFailed();
         ...
         try {
            ...
            logger.log(Level.WARNING, var62.getMessage(), (Throwable)var62);
         }
         ...
         if (info != null) {
            try {
               ...
               IOException iox = var38;

               try {
                  logger.log(Level.WARNING, "Failed to load player info for " + wurmid + ": " + iox.getMessage(), (Throwable)iox);
                  this.sendCommandFailed();
         ...
         if (info != null && info.wurmId > 0L) {
            ...
            try {
               ...
               logger.log(Level.WARNING, wurmid + ", failed to set money to " + currentMoney + ".", (Throwable)var36);
         ...
         } catch (UnsupportedEncodingException var60) {
               ...
               try {
                  ...
                  if (dealItems) {
                     try {
                        ...
                        logger.log(Level.INFO, var56.getMessage(), (Throwable)var56);
                     }
                  }
                  ...
                  if (dealItems) {
                     try {
                        ...
                        logger.log(Level.INFO, var55.getMessage(), (Throwable)var55);
                     }
                  }
               }
   ...
   public static final boolean setNewPassword(long playerId, String newHashedPassword) {
      ...
      if (info != null) {
         try {
            ...
            logger.log(Level.WARNING, "Failed to load info for wurmid " + playerId + ". Password unchanged." + var6.getMessage(), (Throwable)var6);
         }
   ...
   public static final void deletePlayer(long id) throws IOException {
      ...
      try {
         ...
         throw new IOException("Problem deleting playerid: " + id + " due to " + var8.getMessage(), var8);
      } finally {
         DbUtilities.closeDatabaseObjects(ps, null);
   ...
   private static final void deletePlayer(String name, long id) throws IOException {
      ...
      try {
         ...
         throw new IOException(name + " " + var9.getMessage(), var9);
      } finally {
         DbUtilities.closeDatabaseObjects(ps, null);
         DbConnector.returnConnection(dbcon);
      }
      ...
      if (WurmId.getType(id) != 19) {
         ...
         try {
            ...
            if (dbstrings == ItemDbStrings.getInstance()) {
               DbStrings var13 = FrozenItemDbStrings.getInstance();
               ps = dbcon.prepareStatement(var13.deleteTransferedItem());
               ps.setLong(1, id);
               if (rows == 0) {
            ...
            if (!Servers.localServer.LOGINSERVER) {
               throw new IOException(id + " " + var11.getMessage(), var11);
            }

            logger.log(Level.WARNING, "ITEMDELETE Failed to delete item " + id + " " + var11.getMessage(), (Throwable)var11);
         } finally {
            DbUtilities.closeDatabaseObjects(ps, null);
            DbConnector.returnConnection(dbcon);
         }
   ...
   private boolean unpackPlayerData(int posx, int posy, boolean surfaced) {
      try {
         ...
         logger.log(Level.WARNING, "Unpack exception " + var5.getMessage(), (Throwable)var5);
         return false;
      }
   }
      ...
      try {
         ...
         if (cultist == null) {
            ...
            try {
               ...
               logger.log(Level.WARNING, "Failed to save cultist " + name + " level=" + clevel + " path=" + cpath + " " + var31.getMessage(), (Throwable)var31);
            }
            ...
            try {
               ...
               logger.log(Level.WARNING, "Failed to save cultist " + name + " level=" + clevel + " path=" + cpath + " " + var30.getMessage(), (Throwable)var30);
            }
      ...
      try {
         ...
         if (pinf == null) {
            try {
               ...
               logger.log(Level.WARNING, "Creation exception " + var106.getMessage(), (Throwable)var106);
               return -1L;
            }
         ...
         if (pinf != null) {
            if (awards) {
               ...
               if (pinf.awards != null) {
                  pinf.awards = new Awards(
                     wurmId, daysPrem, monthsPaidEver, monthsPaidInARow, monthsPaidSinceReset, silverPaidEver, lastTicked, currentLoyalty, totalLoyalty, false
                  );
                  pinf.awards.update();
               } else {
                  pinf.awards = new Awards(
                     wurmId, daysPrem, monthsPaidEver, monthsPaidInARow, monthsPaidSinceReset, silverPaidEver, lastTicked, currentLoyalty, totalLoyalty, true
                  );
               }
            }
         ...
         EpicPlayerTransferMetaData pmd = new EpicPlayerTransferMetaData(
            wurmId,
            name,
            password,
            session,
         ...
         if (pinf != null) {
            ...
            try {
               ...
               logger.log(Level.WARNING, var105.getMessage());
            }
         }
         ...
         logger.log(Level.WARNING, "Unpack exception " + var107.getMessage(), (Throwable)var107);
         return -1L;
      } finally {
         if (dis != null) {
            try {
      ...
      if (saving) {
         ...
         try {
            ...
            if (dis.readBoolean()) {
               ...
               } catch (NoSuchPlayerException var243) {
               } catch (Exception var244) {
                  logger.log(Level.WARNING, var244.getMessage(), (Throwable)var244);
               }
               ...
               for(int w = 0; w < numwounds; ++w) {
                  WoundMetaData wm = new WoundMetaData(
                     dis.readLong(),
                     dis.readByte(),
                     dis.readByte(),
                     dis.readFloat(),
               ...
               if (info == null) {
                  ...
                  try {
                     ...
                     logger.log(
                        Level.INFO,
                        "Found old player info for the name " + name + ". Deleting old information with wurmid " + info.wurmId + ". New wurmid=" + wurmId
                     );
                     if (info.wurmId > 0L) {
               ...
               if (pet != -10L) {
                  if (!Creatures.getInstance().isCreatureOffline(pet)) {
                     ...
                     } catch (NoSuchCreatureException var241) {
               ...
               if (Servers.localServer.PVPSERVER) {
                  ...
                  if (info != null && info.getDeity() != null && info.getDeity().getNumber() == 4) {
                     BitSet flag2Bits = MiscConstants.createBitSetLong(flags2);
                     if (!flag2Bits.get(11)) {
                        if (deity == 0) {
                           deity = 4;
                        }
                  ...
                  if (Deities.getDeity(deity) != null
                     && !QuestionParser.doesKingdomTemplateAcceptDeity(Kingdoms.getKingdomTemplateFor(kingdom), Deities.getDeity(deity))) {
                     if (kingdom == 4) {
                        kingdom = 3;
                     } else {
                        faith = 0.0F;
                  ...
                  kingdom = Servers.localServer.getKingdom() != 0 ? Servers.localServer.getKingdom() : 4;
               ...
               float px = (float)((posx << 2) + 2);
               float py = (float)((posy << 2) + 2);
               float posz = 0.0F;
               int zoneId = 0;
               if (!Servers.localServer.LOGINSERVER) {
                  try {
                  ...
                  } catch (NoSuchZoneException var245) {
               ...
               if (numcooldowns > 0) {
                  for(int x = 0; x < numcooldowns; x += 1) {
               ...
               for(int xa = 0; xa < numAffinities; xa += 1) {
                  int skillNumber = dis.readInt();
                  int affinity = dis.readByte() & 255;
                  if (affinity > 0) {
               ...
               for(int seff = 0; seff < numspeffects; seff += 1) {
               ...
               try {
                  ...
                  logger.warning("Exception unpacking recipes: " + var240.getMessage());
               ...
               if (info != null) {
                  ...
                  try {
                     ...
                     logger.log(Level.WARNING, var239.getMessage());
                  }
               ...
               if (draggedItem >= 0L) {
                  try {
                     ...
                     try {
                        ...
                        z.addItem(d);
                     } catch (NoSuchZoneException var237) {
                        logger.log(Level.WARNING, var237.getMessage(), (Throwable)var237);
                     }
                  } catch (NoSuchItemException var238) {
            ...
            saving = false;
            logger.log(Level.WARNING, "Unpack exception " + var246.getMessage(), (Throwable)var246);
            return -1L;
         } finally {
            saving = false;
            if (dis != null) {
   ...
   public static void createItem(DataInputStream dis, float posx, float posy, float posz, Set<ItemMetaData> metadataset, boolean frozen) throws IOException {
      try {
         ...
         logger.log(Level.WARNING, "Exception", (Throwable)var75);
      }
      ...
      if (hasInscription) {
         ...
         try {
            ...
            logger.log(Level.WARNING, var73.getMessage(), (Throwable)var73);
         }
      }
   ...
   private void validateTransferRequest(ByteBuffer byteBuffer) {
      if (this.wurmserver.isLagging()) {
         ...
         boolean isDev = byteBuffer.get() != 0;
   ...
   private void validate(ByteBuffer byteBuffer) {
      ...
      if (protocolVersion != 1) {
         ...
         try {
            ...
            logger.log(Level.WARNING, "Unsupported encoding for password.", (Throwable)var10);
         }
   ...
   private void sendLoginAnswer(boolean ok, String message, int retrySeconds) throws IOException {
      try {
         ...
         logger.log(Level.WARNING, "Failed to send login answer.", (Throwable)var6);
      }
   }
   ...
   private void sendTransferUserRequestAnswer(boolean ok, String sessionKey, int retrySeconds) throws IOException {
      try {
         ...
         logger.log(Level.WARNING, "Failed to send TransferUserRequest answer.", (Throwable)var6);
      }
   }
   ...
   private void sendCommandDone() throws IOException {
      try {
         ...
         logger.log(Level.WARNING, "Failed to send command done.", (Throwable)var2);
      }
   }
   ...
   private void sendCommandFailed() throws IOException {
      ...
      try {
         ...
         logger.log(Level.WARNING, "Failed to send command failed.", (Throwable)var2);
      }
   }
   ...
   private void sendDataReceived() throws IOException {
      try {
         ...
         logger.log(Level.WARNING, "Failed to send DataReceived.", (Throwable)var2);
      }
   }
   ...
   private void sendTimeSync() throws IOException {
      try {
         ...
         logger.log(Level.WARNING, "Failed to send timesync.", (Throwable)var2);
      }
   ...
   private void sendPlayerVersion(long playerversion) throws IOException {
      try {
         ...
         logger.log(Level.WARNING, "Failed to send player version.", (Throwable)var4);
      }
   ...
   private void sendPlayerPaymentExpire(long paymentExpire) throws IOException {
      try {
         ...
         logger.log(Level.WARNING, "Failed to send expiretime.", (Throwable)var4);
         this.sendCommandFailed();
      }
   ...
   private void sendPingAnswer() throws IOException {
      try {
         ...
         logger.log(Level.WARNING, "Failed to send ping answer.", (Throwable)var2);
         this.sendCommandFailed();
      }
   }
}
