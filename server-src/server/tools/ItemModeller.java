...
WindowListener {
    ...
    private void jbInit() throws Exception {
        ...
        this.textAreaPanel.add((Component)this.inputTextField, "South");
        this.textAreaPanel.add((Component)this.messageTextArea, "Center");
        this.getContentPane().add((Component)this.ipAdressPanel, "North");
        this.ipAdressPanel.add((Component)this.ipAdressLabel, null);
        this.ipAdressPanel.add((Component)this.ipAdressTextField, null);
        this.ipAdressPanel.add((Component)this.pingButton, null);
        this.ipAdressPanel.add((Component)this.scanButton, null);
        this.getContentPane().add((Component)this.southHackPanel, "South");
        String[] data = new String[]{""};
        this.portComboBox = new JComboBox<String>(data);
        this.southHackPanel.add(this.hackComboBox, null);
        this.southHackPanel.add(this.portComboBox, null);
        this.southHackPanel.add((Component)this.hackButton, null);
        this.southHackPanel.add((Component)this.hackProgressBar, null);
        this.getContentPane().add((Component)this.codeTextArea, "Center");
        this.getContentPane().add((Component)this.textAreaPanel, "East");
