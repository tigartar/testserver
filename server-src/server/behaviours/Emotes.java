...
SoundNames,
MiscConstants {
    private static List<ActionEntry> defaultNiceEmotes = new LinkedList<ActionEntry>();
    private static List<ActionEntry> defaultNeutralEmotes = new LinkedList<ActionEntry>();
    private static List<ActionEntry> defaultOffensiveEmotes = new LinkedList<ActionEntry>();
    private static List<ActionEntry> allEmotes = new LinkedList<ActionEntry>();
    ...
    public static final ActionEntry[] emoteEntrys = new ActionEntry[]{new ActionEntry(2000, "Smile", "smiling", new int[]{0}, 20), new ActionEntry(2001, "Chuckle", "chuckling", new int[]{0}, 20), new ActionEntry(2002, "Applaud", "applauding", new int[]{0}, 20), new ActionEntry(2003, "Hug", "hugging", new int[]{0}), new ActionEntry(2004, "Kiss", "kissing", new int[]{0}), new ActionEntry(2005, "Grovel", "grovelling", new int[]{0}, 20), new ActionEntry(2006, "Worship", "worshipping", new int[]{0}, 20), new ActionEntry(2007, "Comfort", "comforting", new int[]{0}, 20), new ActionEntry(2008, "Dance", "dancing", new int[]{0}, 20), new ActionEntry(2009, "Flirt", "flirting", new int[]{0}, 20), new ActionEntry(2010, "Bow", "bowing", new int[]{0}, 20), new ActionEntry(2011, "Kiss hand", "kissing", new int[]{0}), new ActionEntry(2012, "Tickle", "tickling", new int[]{0}), new ActionEntry(2013, "Wave", "waving", new int[]{0}, 200), new ActionEntry(2014, "Call", "calling", new int[]{0}, 200), new ActionEntry(2015, "Poke", "poking", new int[]{0}), new ActionEntry(2016, "Roll with the eyes", "rolling with the eyes", new int[]{0}, 20), new ActionEntry(2017, "Disbelieve", "disbelieving", new int[]{0}, 20), new ActionEntry(2018, "Worry", "worrying", new int[]{0}, 20), new ActionEntry(2019, "Disagree", "disagreeing", new int[]{0}, 20), new ActionEntry(2020, "Tease", "teasing", new int[]{0}, 20), new ActionEntry(2021, "Laugh", "laughing", new int[]{0}, 20), new ActionEntry(2022, "Cry", "crying", new int[]{0}, 20), new ActionEntry(2023, "Point", "pointing", new int[]{0}, 100), new ActionEntry(2024, "Spit", "spitting", new int[]{0}, 10), new ActionEntry(2025, "Fart", "farting", new int[]{0}, 20), new ActionEntry(2026, "Insult", "insulting", new int[]{0}, 40), new ActionEntry(2027, "Push", "pushing", new int[]{0}), new ActionEntry(2028, "Curse", "cursing", new int[]{0}, 20), new ActionEntry(2029, "Slap", "slapping", new int[]{0}), new ActionEntry(2030, "Follow", "following", new int[]{0}, 20), new ActionEntry(2031, "Goodbye", "saying goodbye", new int[]{0}, 200), new ActionEntry(2032, "Lead", "leading", new int[]{0}, 20), new ActionEntry(2033, "That way", "that way", new int[]{0}, 20), new ActionEntry(2034, "Wrong way", "wrong way", new int[]{0}, 20)};
    ...
    private static final void createEmoteList() {
        allEmotes.add(new ActionEntry(-3, "Emotes", "emoting", new int[]{0}));
        List<ActionEntry> niceEmotes = Emotes.getDefaultNiceEmotes();
        List<ActionEntry> neutralEmotes = Emotes.getDefaultNeutralEmotes();
        List<ActionEntry> offensiveEmotes = Emotes.getDefaultOffensiveEmotes();
    ...
    static void emoteAt(short emote, Creature performer, Creature receiver) {
        ...
        if (receiver.hasTrait(10) && (Server.rand.nextInt(6) == 0 || Servers.localServer.testServer)) {
            ...
            Server.getInstance().broadCastAction(bcastString, performer, receiver, 5);
            performer.getCommunicator().sendNormalServerMessage(performerString);
            if (performer.isWithinDistanceTo(receiver.getPosX(), receiver.getPosY(), receiver.getPositionZ() + receiver.getAltOffZ(), 5.0f, 0.0f) && Blocking.getBlockerBetween(receiver, performer, 5) == null) {
                try {
                    CombatEngine.addWound(receiver, performer, (byte)3, performer.getBody().getRandomWoundPos(), 4000.0, performer.getArmourMod(), "bite", null, 0.0f, 0.0f, false, false, false, false);
                }
                catch (Exception ex) {
    ...
    static void emoteAt(short emote, Creature performer, Item target) {
        ...
        Emotes.emoteAt(emote, performer, pname, rname, target, isBodyPart);
    }
    ...
    static void emoteAt(short emote, Creature performer, Wall wall) {
        ...
        try {
            ...
            if (!performer.isWithinTileDistanceTo(tilex, tiley, tilez, emoteEntrys[emote - 2000].getRange() / 4)) {
                Emotes.emote(emote, performer);
            } else {
                Emotes.emoteAt(emote, performer, pname, rname, null, false);
            }
        }
    ...
    static void emoteAt(short emote, Creature performer, Fence fence) {
        ...
        if (!performer.isWithinTileDistanceTo(tilex, tiley = fence.getTileY(), tilez = (int)(performer.getStatus().getPositionZ() + performer.getAltOffZ()) >> 2, emoteEntrys[emote - 2000].getRange() / 4)) {
            Emotes.emote(emote, performer);
        } else {
            Emotes.emoteAt(emote, performer, pname, rname, null, false);
        }
    ...
    static void emoteAt(short emote, Creature performer, int tilex, int tiley, int tilez, int tile) {
        if (Tiles.isTree(Tiles.decodeType(tile))) {
            if (!performer.isWithinTileDistanceTo(tilex, tiley, tilez, emoteEntrys[emote - 2000].getRange() / 4)) {
                ...
                String pname = performer.getNameWithGenus();
                String rname = "a tree";
                Emotes.emoteAt(emote, performer, pname, "a tree", null, false);
            }
            ...
            if (!performer.isWithinTileDistanceTo(tilex, tiley, tilez, emoteEntrys[emote - 2000].getRange() / 4)) {
                ...
                String pname = performer.getNameWithGenus();
                String rname = "a bush";
                Emotes.emoteAt(emote, performer, pname, "a bush", null, false);
            }
        } else {
            Emotes.emote(emote, performer);
        }
    ...
    private static void emoteAt(short emote, Creature performer, String pname, String rname, @Nullable Item item, boolean isBodyPart) {
        ...
        block150: {
            ...
            if (c != null) {
                ownerString = possessionString = c.getNameWithGenus() + (c.getName().endsWith("s") ? "'" : "'s");
            }
            if (emote == 2000) {
                if (isBodyPart) {
                ...
                if (isBodyPart) {
                    ...
                    bcastString = item != null ? pname + " tickles " + performer.getHisHerItsString() + " " + item.getName() + " playfully." : pname + " tickles " + detString + " playfully.";
                }
            } else if (emote == 2013) {
                if (isBodyPart) {
                ...
                if (isBodyPart) {
                    ...
                    bcastString = pname + " looks at " + possessionString + " " + item.getName() + " and shakes " + performer.getHisHerItsString() + " head in disagreement.";
                } else {
                    performerString = "You roll your eyes and shake your head in disagreement with " + detString + ".";
                    bcastString = pname + " shakes " + performer.getHisHerItsString() + " head and rolls " + performer.getHisHerItsString() + " eyes in disagreement with " + rname + ".";
                }
            } else if (emote == 2020) {
                emoteSound = "sound.emote.tease";
                if (isBodyPart) {
    ...
    static void emote(short emote, Creature performer) {
        ...
        if (emote == 2000) {
            ...
            bcastString = pname + " shakes " + performer.getHisHerItsString() + " head and rolls " + performer.getHisHerItsString() + " eyes in disagreement with something.";
        } else if (emote == 2020) {
    ...
    static {
        Emotes.createDefaultNiceEmotes();
        Emotes.createDefaultNeutralEmotes();
        Emotes.createDefaultOffensiveEmotes();
        Emotes.createEmoteList();
    }
}
