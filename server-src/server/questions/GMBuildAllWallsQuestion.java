            ...
            try {
               ...
               if (prop != null) {
                  ...
                  this.getResponder()
                     ...
                     .log(
                        Level.INFO,
                        "Building all unfinished walls of structure with ID="
                           + this.targetStructure.getWurmId()
                           + "to type "
                           + this.wallList.get(wallId).getName()
                     );
                     ...
                     if (w.isWallPlan()) {
                        ...
                        if (w.isDoor()) {
                           ...
                           try {
                              ...
                              logger.warning("Failed to save door! " + var10);
