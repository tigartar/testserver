...
public class ChangeMedPathQuestion extends Question {
   ...
   public void sendQuestion() {
      ...
      if (this.cultist.getPath() == 4) {
         buf.append(
            "text{type=\"bold\";text=\"Choose which path you want to change to. This cannot be undone. This change is only available once, and only from the path of insanity.\"}"
         );
