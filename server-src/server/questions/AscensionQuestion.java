...
implements MiscConstants {
    ...
    public void sendQuestion() {
        ...
        buf.append("text{text=\"The demigod" + this.getResponder().getName() + " would be in charge of and protecting a special area of Valrei and aiding your deity.\"};");
        buf.append("text{text=''}");
        buf.append("text{text=\"Nothing will be changed on your current character except the name.\"};");
        buf.append("text{text=''}");
        buf.append("text{text=\"" + this.getResponder().getName() + " will play on as a demigod of " + this.deityName + " and if all goes well be elevated to true Deity.\"};");
        ...
        buf.append("text{text=\"There are no promises made that " + this.deityName + " will be able to elevate your demigod to a true Deity and In the worst case the demigod is even killed or demoted.\"};");
        buf.append("text{text=''}");
