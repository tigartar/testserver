...
extends Question {
    ...
    public TicketUpdateQuestion(Creature aResponder, int aTicketId, short aAction) {
        super(aResponder, "Ticket: #" + aTicketId, TicketUpdateQuestion.makeQuestion(aResponder, aAction), 108, aTicketId);
        ...
        if (this.type == 108) {
            ...
            switch (this.action) {
                ...
                case 597: {
                    ...
                    byte general = (byte)((general1 ? 1 : 0) + (general2 ? 2 : 0) + (general3 ? 4 : 0) + (general4 ? 8 : 0) + (general5 ? 16 : 0) + (general6 ? 32 : 0) + (general7 ? 64 : 0));
                    ...
                    byte quality = (byte)((quality1 ? 1 : 0) + (quality2 ? 2 : 0) + (quality3 ? 4 : 0) + (quality4 ? 8 : 0) + (quality5 ? 16 : 0) + (quality6 ? 32 : 0));
                    ...
                    ticket.addNewTicketAction((byte)14, this.getResponder().getName(), note, level, service, courteous, knowledgeable, general, quality, irked);
                    break;
                }
            }
        }
        ...
        if (player.getWurmId() == ticket.getPlayerId() && this.action != 591) {
            ...
            if (ticket.isOpen()) {
                ...
                if (ticket.hasFeedback()) {
                    ...
                    buf.append("text{type=\"bold\";text=\"Briefly describe any aspect of the process and/or team member which you considered outstanding or could be improved.\"}");
                    buf.append("input{id=\"note\";maxchars=\"200\";text=\"\"}");
                    buf.append("text{text=\"Thank you for your feedback. We sincerely appreciate your honest opinion and will take your input into consideration while providing services in the future.\"};");
                }
            } else {
                buf.append("passthrough{id=\"append\";text=\"false\"}");
    ...
    private void showReadOnlyFeedback(Ticket ticket, StringBuilder buf) {
        ...
        buf.append("radio{group=\"knowledgeable\";id=\"4\";text=\"Somewhat Disagree\";enabled=\"false\";selected=\"" + ta.wasKnowledgeableSomewhatDisagree() + "\"}");
        buf.append("radio{group=\"knowledgeable\";id=\"5\";text=\"Strongly Disagree\";enabled=\"false\";selected=\"" + ta.wasKnowledgeableStronglyDisagree() + "\"}");
        buf.append("text{type=\"bold\";text=\"The Support Team:\"}");
