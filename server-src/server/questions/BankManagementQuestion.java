               ...
               if (!this.bank.open) {
                  ...
                  if (val != null && val.equals("true")) {
                     if (this.bank.targetVillage > 0) {
                        try {
                           Village disbanded = Villages.getVillage(this.bank.targetVillage);
                        ...
                        } catch (BankUnavailableException var8) {
                           disbanded = true;
                        }
   ...
   public void sendQuestion() {
      ...
      if (!this.getResponder().isGuest()) {
         if (this.bank == null) {
            ...
            buf.append(
               "text{text='A bank account will currently not move items between servers, but your money will be available if you open a new bank account on another server.'}"
            );
            ...
            if (this.bank.startedMoving > 0L) {
               if (vill != null) {
                  ...
                  buf.append(
                     "text{text='It will arrive in approximately "
