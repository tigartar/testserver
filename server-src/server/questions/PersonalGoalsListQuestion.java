...
public class PersonalGoalsListQuestion extends Question {
   ...
   public void sendQuestion() {
      ...
      if (this.getResponder().getPower() >= 4) {
         ...
         HashSet<AchievementTemplate> goals = (HashSet)Achievements.getPersonalGoals(this.getTarget(), false);
         HashSet<AchievementTemplate> oldGoals = (HashSet)Achievements.getOldPersonalGoals(this.getTarget());
