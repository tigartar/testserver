    ...
    public void answer(Properties aAnswers) {
        ...
        if (prop != null) {
            try {
                ...
                if (num == Cults.getCorrectAnswerForNextLevel(this.cultist.getPath(), this.cultist.getLevel())) {
                    if (this.cultist == null) {
                        this.cultist = new Cultist(this.getResponder().getWurmId(), this.path);
                    }
                    ...
                    try {
                        ...
                        logger.log(Level.WARNING, "Failed to set " + this.getResponder().getName() + " to level " + iox.getMessage(), iox);
                    }
                }
                if (this.cultist == null) {
        ...
        if (this.askStatus) {
            ...
            for (Integer level : treemap.keySet()) {
                ...
                for (Cultist cist : subset) {
                    ...
                    if (pinf == null || pinf.currentServer != localServer) continue;
