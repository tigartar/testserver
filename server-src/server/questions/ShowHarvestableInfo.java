...
public final class ShowHarvestableInfo extends Question {
   ...
   public ShowHarvestableInfo(Creature aResponder, Item paper, WurmHarvestables.Harvestable harvestable) {
      super(aResponder, getReportName(paper, harvestable), getReportName(paper, harvestable), 141, -10L);
      this.almanac = null;
      this.paper = paper;
   ...
   private static String getReportName(Item paper, WurmHarvestables.Harvestable harvestable) {
      return LoginHandler.raiseFirstLetter(harvestable.getName() + " report (" + df.format((double)paper.getCurrentQualityLevel()) + ")");
   }
   ...
   public ShowHarvestableInfo(Creature aResponder, Item almanac, int summarytype) {
      super(aResponder, getSummaryName(almanac, summarytype), getSummaryName(almanac, summarytype), 141, -10L);
   ...
   public void sendQuestion() {
      ...
      if (this.almanac != null) {
         dropdown = "button{text=\"Show\";id=\"show\"};label{text=\" \"};dropdown{id=\"by\";default=\""
            + this.filter
            + "\";options=\"All,Harvestables,Almost Ripe,(Nearly) Harvestable\"};";
      }
      ...
      buf.append(
         "border{border{size=\"20,20\";null;null;label{type='bold';text=\""
            ...
            + "\"};harray{"
            + dropdown
            + "label{text=\" \"};button{text=\"Close\";id=\"close\"};label{text=\" \"}};null;}null;scroll{vertical=\"true\";horizontal=\"false\";varray{rescale=\"true\";passthrough{id=\"id\";text=\""
            + this.getId()
            + "\"}"
      );
   ...
   private String showSummary() {
      ...
      if (reports.length == 0) {
         ...
         buf.append(
            "table{rows=\"1\";cols=\"5\";text{type=\"bold\";text=\"Report\"};label{type=\"bold\";text=\"QL\"};label{type=\"bold\";text=\"State\"};label{type=\"bold\";text=\"Harvest Start\"};label{type=\"bold\";text=\"Harvest End\"};"
         );
         ...
         for(Item report : reports) {
            ...
            if (harvestable != null) {
               ...
               if (harvestable.isHarvestable() && this.showSummaryHarvestables()) {
                  ...
                  colourStart = "color=\"127,255,127\"";
                  colourState = "color=\"127,255,127\"";
                  output = true;
               ...
               if (output) {
                  buf.append(
                     "label{"
                        ...
                        + colourState
                        + "text=\""
                        + df.format((double)report.getCurrentQualityLevel())
                        + "\"};label{"
                        + colourState
                        + "text=\""
                        + harvestable.getState()
                        + "\"};label{"
                        + colourStart
                        + "text=\""
                        + harvestStart
               ...
               buf.append(
                  "label{color=\"255,127,127\"text=\"Invalid\"};label{color=\"255,127,127\"text=\"\"};label{color=\"255,127,127\"text=\"Unknown\"};label{color=\"255,127,127\"text=\"Unknown\"};label{color=\"255,127,127\"text=\"Unknown\"};"
               );
            }
         }
   ...
   private String showHarvestableTimes() {
      ...
      if (this.harvestable.isHarvestable()) {
         ...
         buf.append(
            "text{text=\"The default harvest season is in "
               + WurmCalendar.getDaysFrom(this.harvestable.getDefaultSeasonStart())
               + " This is only approximate as it can be plus or minus 2 weeks from that date. \"}"
         );
      }
   ...
   private String showOliveInfo() {
      ...
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"The olive tree, known by the botanical name Olea wurmea, meaning ''Wurm olive'', is a small tree with a wide, gnarled trunk.  It is found and cultivated in many places and considered naturalized in all the lands of Wurm.  It is part of the Oleaceae family, and represents the earliest source of oil in Wurm history.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append("image{src=\"img.almanac.produce.olive\";size=\"128,128\";text=\"Olive fruit\"}");
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"The fruit of the olive tree, also called the olive, is of major agricultural importance in wurm as the source of olive oil. The tree and its fruit give their name to the plant family. The word ''oil'' in multiple languages ultimately derives from the name of this tree and its fruit, signifying its importance in many economies.\"}"
      );
      return buf.toString();
   }
   ...
   private String showCherryInfo() {
      ...
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"The Wurmian cherry, or Prunus avia wurmosa, is found in most areas.  Known for its distinctive flowers, which occur in small corymbs of several together, the fruit is smooth skinned, with a weak groove (or no groove) along one side.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append("image{src=\"img.almanac.produce.cherry\";size=\"128,128\";text=\"Cherries\"}");
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"Cherry fruit is a fleshy drupe (stone fruit), growing in clusters of 2 or 3.  Wurmians have been known to use cherries for a variety of cooked dishes, as well as several drinks (both alcoholic and non-alcoholic).  It is also of great economic value to alchemists, as the juice may be used for tile transformation.\"}"
      );
      buf.append("label{text=\" \"}");
      buf.append(
         "text{text=\"Due to the small size of Prunus trees, cherry wood is time-consuming to harvest in large quantities, and requires advanced carpentry techniques to combine the inevitable small harvested logs into usable lumber.\"}"
      );
      return buf.toString();
   }
   ...
   private String showLemonInfo() {
      ...
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"The lemon, or Citrus limon, is a species of small evergreen tree in the flowering plant family Rutaceae.  It is native to Wurm, and is found in all areas of the world.  Originally used for ornamental or medicinal purposes, lemons are now produced in large-scale cultivation.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append("image{src=\"img.almanac.produce.lemon\";size=\"128,128\";text=\"Lemon\"}");
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"The tree's ellipsoidal yellow fruit is used for culinary and non-culinary purposes throughout Wurm.  The juice, pulp and rind (zest) are all used in cooking and baking, and the juice also has useful alchemical properties.  The juice of the lemon is about 5% to 6% citric acid, which gives a distinctive sour taste; this makes it a key ingredient in drinks and foods such as lemonade.\"}"
      );
      return buf.toString();
   }
   ...
   private String showLavenderInfo() {
      ...
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"Lavandula (common name lavender) is a genus of flowering plants in the mint family, Lamiaceae. It is native to the Old World and is found in all lands of Wurm. Many members of the genus are cultivated extensively in temperate climates as ornamental plants for garden and landscape use, even as hedges, for use as culinary herbs.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append("image{src=\"img.almanac.produce.lavender\";size=\"128,128\";text=\"Lavender\"}");
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"The most widely cultivated species, Lavandula angustifolia, is often referred to as lavender, and there is a color named for the shade of the flowers of this species.  The flowers have a distinctive odour, and the bush is often cultivated into low hedges.\"}"
      );
      return buf.toString();
   }
   ...
   private String showMapleInfo() {
      ...
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"Acer is a genus of trees or shrubs commonly known as maple. The type species of the genus is the sycamore maple, Acer pseudoplatanus, the most common maple species in Wurm.  Originally from Celebration, it is known for its sweet sap and light-coloured wood.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append("image{src=\"img.almanac.produce.maple\";size=\"128,128\";text=\"Maple Sap\"}");
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"Maple syrup is usually made from the xylem sap of  maple trees. In cold climates, these trees store starch in their trunks and roots before the winter; the starch is then converted to sugar that rises in the sap in late winter and early spring. Maple trees are tapped by boring holes into their trunks and collecting the exuded sap, which is processed by heating to evaporate much of the water, leaving the concentrated syrup.\"}"
      );
      return buf.toString();
   }
   ...
   private String showChestnutInfo() {
      ...
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"The chestnut group is a genus (Castanea) of species of deciduous trees in the beech family Fagaceae, native to temperate regions of Wurm.  Often growing in tightly-packed groves, they produce a sweet nut late in the year.  Older chestnut trees can grow to prodigious thickness.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append("image{src=\"img.almanac.produce.chestnut\";size=\"128,128\";text=\"Chestnut\"}");
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"Chestnut trees produce a sweet nut, also called chestnuts.  The name comes from the spiny husk covering the nuts; opening up this 'chest' reveals the sweet treasure inside.  Younger Wurmians often celebrate winter by throwing the prickly nuts at each other.\"}"
      );
      return buf.toString();
   }
   ...
   private String showWalnutInfo() {
      ...
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"A walnut is any tree of the genus Juglans (Family Juglandaceae).  Found throughout the lands of Wurm, it forms a mid-height tree with distinctive dark green leaves.  The wood of the walnut tree is particularly dense, and thus of interest to coal makers.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append("image{src=\"img.almanac.produce.walnut\";size=\"128,128\";text=\"Walnut\"}");
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"Technically a walnut is the seed of a drupe or drupaceous nut, and thus not a true botanical nut. It is used for food after being processed while green for pickled walnuts or after full ripening for its nutmeat. The walnut is nutrient-dense with protein and essential fatty acids.\"}"
      );
      return buf.toString();
   }
   ...
   private String showOakInfo() {
      ...
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"The mighty oak is a tree in the genus Quercus of the beech family, Fagaceae.  Oak trees are one of the slowest-growing plants known to Wurmkind, producing an exceptionally tough wood; this is much prized by tool-makers, as being more durable than other timber.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"Oaks have spirally arranged leaves, with lobate margins in many species; some have serrated leaves or entire leaf with smooth margins. Also, the acorns contain tannic acid, as do the leaves, which helps to guard from fungi and insects. Many deciduous species are marcescent, not dropping dead leaves until spring. In spring, a single oak tree produces both male flowers (in the form of catkins) and small female flowers.  The high acidity of the tree often kills other plants in the vicinity.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append("image{src=\"img.almanac.produce.oak\";size=\"128,128\";text=\"Acorn\"}");
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"The fruit is a nut called an acorn, borne in a cup-like structure known as a cupule; each acorn contains one seed (rarely two or three). The acorns contain tannic acid, which may be extracted by skilled alchemists for use in dye production.  Acorns may be found on the ground at any time, but the best quality ones are harvested directly from the trees when ripe.\"}"
      );
      return buf.toString();
   }
   ...
   private String showBlueberryInfo() {
      ...
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"Growing in low shrubs, members of the Cyanococcus bush produce bell-shaped flowers and dark blue berries.  Originally cultivated on Independance, they have been carried to other lands.  Some other families of plants are also commonly referred to as blueberries, mainly derived from the myrtles.  The bush is frost-hardy, and will grow in most soils, although it prefers well-drained, slightly alkaline conditions.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append("image{src=\"img.almanac.produce.blueberry\";size=\"128,128\";text=\"Blueberry\"}");
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"Blueberries start out pale green, but darken as they ripen, ending up a very dark purple.  The berries are small, and grow in clusters, having a natural protective wax coating.  Typically harvested in mid-summer, blueberries are known for staining tongues blue all over Wurm.\"}"
      );
      return buf.toString();
   }
   ...
   private String showLingonberryInfo() {
      ...
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"Vaccinium vitis-idaea (lingonberry, partridgeberry, or cowberry) is a short evergreen shrub in the heath family that bears edible fruit, native to tundra throughout Wurm. Lingonberries are picked in the wild and used to accompany a variety of dishes.\"}"
      );
      buf.append("text{text=\"\"}");
      buf.append("image{src=\"img.almanac.produce.lingonberry\";size=\"128,128\";text=\"Lingonberry\"}");
      buf.append("text{text=\"\"}");
      buf.append(
         "text{text=\"The berries are quite tart, so they are often cooked and sweetened before eating in the form of lingonberry jam or juice.  The berries are also popular as a wild picked fruit in Release, where they are locally known as partridgeberries or redberries, and on the mainland of Celebration, where they are known as foxberries. In this region they are incorporated into jams, syrups, and baked goods, such as pies, scones, and muffins.\"}"
      );
      return buf.toString();
   }
}
