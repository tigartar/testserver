...
public final class AlertServerMessageQuestion extends Question {
   ...
   public void answer(Properties answers) {
      ...
      if (mess1 != null && mess1.length() != 0) {
         String msg1 = mess1.replaceAll("\"", "");
         Server.alertMessage1 = msg1;
      ...
      if (mess2 != null && mess2.length() != 0) {
         String msg2 = mess2.replaceAll("\"", "");
         Server.alertMessage2 = msg2;
      ...
      if (mess3 != null && mess3.length() != 0) {
         String msg3 = mess3.replaceAll("\"", "");
         Server.alertMessage3 = msg3;
      ...
      if (mess4 != null && mess4.length() != 0) {
         String msg4 = mess4.replaceAll("\"", "");
         Server.alertMessage4 = msg4;
      ...
      WcGlobalAlarmMessage wgam = new WcGlobalAlarmMessage(
         Server.alertMessage3, Server.timeBetweenAlertMess3, Server.alertMessage4, Server.timeBetweenAlertMess4
      );
   ...
   public void sendQuestion() {
      ...
      sb.append(
         "label{text='Seconds between polls:'};input{id='alt1';text='"
            + (Server.timeBetweenAlertMess1 == Long.MAX_VALUE ? 180L : Server.timeBetweenAlertMess1 / 1000L)
            + "'}"
      );
      ...
      sb.append(
         "label{text='Seconds between polls:'};input{id='alt2';text='"
            + (Server.timeBetweenAlertMess2 == Long.MAX_VALUE ? 180L : Server.timeBetweenAlertMess2 / 1000L)
            + "'}"
      );
      ...
      sb.append(
         "label{text='Seconds between polls:'};input{id='alt3';text='"
            + (Server.timeBetweenAlertMess3 == Long.MAX_VALUE ? 180L : Server.timeBetweenAlertMess3 / 1000L)
            + "'}"
      );
      sb.append("label{text=\"Global Alert message 4:\"};input{id='alm4';text=\"" + Server.alertMessage4 + "\"}");
      sb.append(
         "label{text='Seconds between polls:'};input{id=\"alt4\";text='"
            + (Server.timeBetweenAlertMess4 == Long.MAX_VALUE ? 180L : Server.timeBetweenAlertMess4 / 1000L)
            + "'}"
      );
