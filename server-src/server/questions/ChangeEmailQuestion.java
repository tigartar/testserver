    ...
    public void answer(Properties answers) {
        ...
        block13: {
            ...
            block14: {
                ...
                resend = false;
                this.alertMessage = "";
                newEmail = answers.getProperty("emailAddress");
                String ppassword = answers.getProperty("pwinput2");
                if (ppassword == null || ppassword.length() < 2) {
                    ppassword = this.passProvided;
                }
                if ((pwQuestion = answers.getProperty("pwQuestion")) == null || pwQuestion.length() < 5) {
                ...
                if ((pwAnswer = answers.getProperty("pwAnswer")) == null || pwAnswer.length() < 3) {
                ...
                if (resend) break block13;
                if (newEmail == null || !WebInterfaceImpl.isEmailValid(newEmail)) break block14;
                if (!newEmail.equalsIgnoreCase(((Player)this.getResponder()).getSaveFile().emailAddress)) {
                    ...
                    String isok = lsw.changeEmail(this.getResponder().getName(), this.getResponder().getName(), newEmail, ppassword, this.getResponder().getPower(), pwQuestion, pwAnswer);
                    ...
                    if (isok.contains("- ok")) {
                        try {
                            ...
                            logger.log(Level.INFO, this.getResponder().getName() + " FAILED changed the email to " + newEmail, new Exception());
