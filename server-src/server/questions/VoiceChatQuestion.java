...
public class VoiceChatQuestion extends Question implements TimeConstants, MonetaryConstants {
   ...
   public void sendQuestion() {
      ...
      buf.append(
         "text{text=\"The Ericsson ingame voice chat service is being shut down as of 2013-01-31 due to low interest. We can no longer offer these packages.\"};text{text=\"\"}"
      );
