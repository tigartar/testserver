...
extends Question {
    ...
    public void sendQuestion() {
        ...
        buf.append("text{text='If you are citizen of a village or homestead, the trader will donate part of its income from foreign traders to the settlement funds.'}");
        buf.append("text{text=''}");
        ...
        buf.append("text{text=''}");
        buf.append("text{type=\"bold\";text=\"Note that if the trader is citizen of a settlement when it disbands, he or she will disappear regardless of whether he is on deed or not!\"}");
        if (citiz && v != null) {
