...
public class TransferQuestion extends Question {
         ...
         if (val != null) {
            try {
               ...
               try {
                  ...
                  rp.getCommunicator()
                     .sendNormalServerMessage("An exception occurred when changing deity. Please try again later or use /support if this persists.");
               }
   ...
   public void sendQuestion() {
      ...
      BMLBuilder bml = BMLBuilder.createNormalWindow(
         ...
         "Transfer your faith to which deity?",
         BMLBuilder.createGenericBuilder()
            .addText(
               "You currently have a single use free faith transfer from your current deity of "
                  + this.getResponder().getDeity().getName()
                  + " to another of your choice from the list below."
            )
            .addText("")
            .addText(
               "Once you select which deity to transfer to and click accept, you will not be able to transfer back. Choose wisely.",
               null,
            ...
            .addText("")
            .addText(
               "Warning: Converting to a deity on Freedom then travelling to a Chaos kingdom that does not align with your deity you will lose all faith and abilities granted, and you will stop following that deity. Libila does not align with WL kingdoms and Fo/Vynora/Magranon do not align with BL kingdoms.",
               null,
               BMLBuilder.TextType.BOLD,
               Color.RED
            )
