...
extends Question {
    ...
    public void sendQuestion() {
        ...
        if (Servers.localServer.PVPSERVER) {
            buf.append("text{text='You must also walk this path if you strive to become a real champion of " + this.getResponder().getDeity().name + ".'}text{text=''}");
        }
        ...
        buf.append("text{type='italic';text='Do you want to become a priest of " + this.getResponder().getDeity().name + " despite the severe limitations it will have on your actions?'}");
