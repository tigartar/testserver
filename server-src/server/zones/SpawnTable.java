...
implements CreatureTemplateIds {
    ...
    private static final Set<EncounterType> land = new HashSet<EncounterType>();
    private static final Set<EncounterType> water = new HashSet<EncounterType>();
    private static final Set<EncounterType> beach = new HashSet<EncounterType>();
    private static final Set<EncounterType> deepwater = new HashSet<EncounterType>();
    private static final Set<EncounterType> flying = new HashSet<EncounterType>();
    private static final Set<EncounterType> flyinghigh = new HashSet<EncounterType>();
    private static final Set<EncounterType> caves = new HashSet<EncounterType>();
    ...
    public static EncounterType getType(byte tiletype, byte elevation) {
        ...
        for (EncounterType type : types) {
            if (type.getTiletype() != tiletype) continue;
            return type;
        }
        return null;
    }
    ...
    public static Encounter getRandomEncounter(byte tiletype, byte elevation) {
        EncounterType enc = SpawnTable.getType(tiletype, elevation);
        if (enc != null) {
    ...
    static void createEncounters() {
        ...
        EncounterType grassGround = new EncounterType(Tiles.Tile.TILE_GRASS.id, 0);
        ...
        SpawnTable.addTileType(grassGround);
        EncounterType beachSide = new EncounterType(Tiles.Tile.TILE_SAND.id, 5);
        ...
        SpawnTable.addTileType(beachSide);
        EncounterType rockSide = new EncounterType(Tiles.Tile.TILE_ROCK.id, 1);
        ...
        SpawnTable.addTileType(rockSide);
        EncounterType mycGround = new EncounterType(Tiles.Tile.TILE_MYCELIUM.id, 0);
        ...
        SpawnTable.addTileType(mycGround);
        EncounterType marsh = new EncounterType(Tiles.Tile.TILE_MARSH.id, 0);
        ...
        SpawnTable.addTileType(marsh);
        EncounterType steppe = new EncounterType(Tiles.Tile.TILE_STEPPE.id, 0);
        ...
        SpawnTable.addTileType(steppe);
        EncounterType treeGround = new EncounterType(Tiles.Tile.TILE_TREE.id, 0);
        ...
        SpawnTable.addTileType(treeGround);
        EncounterType sandGround = new EncounterType(Tiles.Tile.TILE_SAND.id, 0);
        ...
        SpawnTable.addTileType(sandGround);
        EncounterType clayGround = new EncounterType(Tiles.Tile.TILE_CLAY.id, 0);
        clayGround.addEncounter(crocodileSingle, 10);
        clayGround.addEncounter(anaconda, 1);
        SpawnTable.addTileType(clayGround);
        EncounterType underGround = new EncounterType(Tiles.Tile.TILE_CAVE.id, -1);
        ...
        SpawnTable.addTileType(underGround);
        EncounterType lavaGround = new EncounterType(Tiles.Tile.TILE_LAVA.id, 0);
        lavaGround.addEncounter(lavaSpiderMulti, 10);
        lavaGround.addEncounter(lavaCreatureSingle, 10);
        SpawnTable.addTileType(lavaGround);
        EncounterType lavaRock = new EncounterType(Tiles.Tile.TILE_LAVA.id, -1);
        lavaRock.addEncounter(lavaCreatureSingle, 10);
        SpawnTable.addTileType(lavaRock);
