...
public final class Puppet implements MiscConstants, TimeConstants {
   ...
   private static final String[] FLSeventyPlus1 = new String[]{
      "@It was better before.", "Not for me. I feel alone.", "So am I. Yet I feel their suspicion and awe.", "You are always so kind and forgiving."
   };
   private static final String[] LFSeventyPlus1 = new String[]{
      "", "This is better.", "I am friends with everyone now.", "Oh, I don't mind. Let them be suspicious.", "How nicely said of you. "
   };
   private static final String[] FLSeventyPlus2 = new String[]{
      "@Come on!", "You said you wanted to. Now I am disappointed.", "Why not?", "It won't.", "I just know.", "Don't be afraid."
   };
   private static final String[] LFSeventyPlus2 = new String[]{
      "",
      "I don't want to!",
      "Yes but now I don't want to.",
      "What if something happens?",
      "How do YOU know?",
      "Please! You make me sad! Stop torturing me!",
      "All that is left is fear."
   };
   private static final String[] VLSeventyPlus1 = new String[]{
      "@Have you done it yet?", "Coward.", "I will say what I want.", "Stop that!", "Well do as you please then. You are ridiculous.", "Do as you please."
   };
   private static final String[] LVSeventyPlus1 = new String[]{
      "", "No. I don't dare to.", "You shouldn't call me that! It's not fair!", "I will say what I want.", "Stop that!", "I'm not! Stop this!"
   };
   private static final String[] VLSeventyPlus2 = new String[]{
   ...
   private static final String[] LVSeventyPlus2 = new String[]{
      "", "Why me? Why is it always me?", "Is that a good reason?", "You have no idea how this hurts.", "You are heartless!"
   };
   private static final String[] MLSeventyPlus1 = new String[]{
      "@I wonder what would help.", "All the time.", "You could do it for me.", "Do not fear. I will be there."
   };
   ...
   private static final String[] MLSeventyPlus2 = new String[]{
   ...
   private static final String[] LMSeventyPlus2 = new String[]{
      "", "It's not your decision!", "How can you say that?", "That's not fair!", "You're not the one who has to do this."
   };
   private static final String[] VFSeventyPlus1 = new String[]{
      "@She actually enters now!", "I start to feel weird.", "Oh my god. Oh dear.", "Magranon! Don't enter!", "Of course. Of course."
   };
   private static final String[] VFSeventyPlus2 = new String[]{
      "", "Yes, I can't believe it. How... fascinating.", "Yes.. it is. I didn't expect to feel this way.", "NO! It can not be!", "He must. Don't you see?"
   };
   private static final String[] FVSeventyPlus1 = new String[]{
      "", "A lot is lost in the pain. But euforia. Visions of mother.", "I wonder if we would survive. Do you?", "We could just touch it!"
   };
   private static final String[] FVSeventyPlus2 = new String[]{
      "@How much do you remember?",
      "What happens if we try again?",
      "I would not take that chance.",
      "Do not speak of it any more please. And not in front of the others."
   };
   private static final String[] VMSeventyPlus1 = new String[]{
      "@Magranon! What did you see? Where is she?",
      "Gone?",
      "Oh love. Oh Magranon! Come here!",
      "We could not know. We could not... Oh Magranon.",
      "Magranon! You agreed to the plan! You accepted!"
   };
   private static final String[] MVSeventyPlus1 = new String[]{
      "",
      "There was a change.. but she is dead.. gone..",
      "Yes.. her body is... shattered.",
      "My sister! My poor poor sister! What have we done?",
      "No.. I did not do this! You did! You both!",
      "No! No! This must be undone!"
   };
   private static final String[] VMSeventyPlus2 = new String[]{
      "",
      "That is weird. I feel only empty.",
      "Your rage is feeding rage. You should lie down with me.",
      "Who knows what would happen? What bad could come of it?",
      "Do not be afraid. Could you be harmed?"
   };
   private static final String[] MVSeventyPlus2 = new String[]{
      "@I feel pain - all sorts of pain.",
      "I burn. I am a forest fire.",
   ...
   private static final String[] FMSeventyPlus1 = new String[]{
      "@So how do you feel about this?", "She will be allright.", "You know I can not make such a promise.", "Yes. I know."
   };
   private static final String[] MFSeventyPlus1 = new String[]{
      "", "Not good honestly. I do not think that it is a good idea.", "Do you promise?", "If anything happens to her I do not know what I will do."
   };
   private static final String[] FMSeventyPlus2 = new String[]{
   ...
   private static final String[] MFSeventyPlus2 = new String[]{
      "",
      "Yes.. I guess you have the right to know about it.",
      "She moved it. I think to her domains.",
      "I think humans helped her. Some prisoners spoke about a construction.",
   ...
   private static final String[] AFSeventyPlus1 = new String[]{
      "@What did you do?", "What happened?", "How?", "Are you asking me?", "You became too powerful."
   };
   ...
   private static final String[] AFSeventyPlus2 = new String[]{
      "@I am scared now. Something is wrong.", "Are you afraid?", "He is broken.", "I wish we could help.", "That is not the right way."
   };
   private static final String[] FASeventyPlus2 = new String[]{
      "", "Yes, it disappeared.", "Not me. No I am not. I am strong - I have to be.", "He is.", "This should all be forgotten."
   };
   private static final String[] AVSeventyPlus1 = new String[]{
      "@Should you not have known better?",
      "It was pretty obvious I think.",
      "So you do not know everything after all?",
      "I fear that one day you will have to pay the price."
   };
   private static final String[] VASeventyPlus1 = new String[]{
      "", "There was no way of knowing!", "Thinking clear is not always easy.", "Not yet. Not yet.", "I will look to the stars. Maybe you are right."
   };
   private static final String[] AVSeventyPlus2 = new String[]{
      "", "Nobody said it was.", "We understand.", "No.. What do you mean?", "Did you?", "Do not start any rumours now."
   };
   private static final String[] VASeventyPlus2 = new String[]{
      "@It was not me! Not me!",
      "She did it to herself I say!",
      "I never meant to.. You know.",
      "Push her or anything.",
      "No.. I mean.. no.",
      "You are right. I should watch my tongue."
   };
   private static final String[] ALSeventyPlus1 = new String[]{
      "@Oh, to find you here. After all this time!",
      "I almost did not recognize you.",
      "You look... horrible... larvae.",
      "I will not. Disgusting!",
      "I will. I can not stand this any longer."
   };
   private static final String[] LASeventyPlus1 = new String[]{
      "", "Help... Help.", "Neither... I.", "Not.. eat.. me...", "Leave.. leave..", "Mok... Kill it!"
   };
   private static final String[] ALSeventyPlus2 = new String[]{
      "", "No! What has happened to you?", "Tricked? I heard of greed.", "I do not believe you.", "For not believing? That is.. a joke?", "No. Not now."
   };
   private static final String[] LASeventyPlus2 = new String[]{
      "@So. Will you retrieve my eye?",
      "Something horrible. I was tricked.",
      "That is a lie!",
      "Then I will slay you.",
      "Do I look like I make jokes now?",
      "Goodbye then."
   };
   private static final String[] AMSeventyPlus1 = new String[]{
      "@What did you do?",
   ...
   private static final String[] MASeventyPlus1 = new String[]{
      "",
      "I did nothing. It was them!",
      "Quiet! Quiet! Do not torment me!",
      "Stop it already! I was also tricked.",
      "I am glad mother did not have to see this."
   };
   private static final String[] AMSeventyPlus2 = new String[]{
   ...
   private static final String[] MASeventyPlus2 = new String[]{
      "",
      "You will stay with me will you not?",
      "I will find new followers then.",
      "I will find a way.",
      "The winds whisper of new times. Something is coming."
   };
   private static final String[] VFSeventyMinus1 = new String[]{
      "", "Who? Libila?", "How?", "A wolf? She would never kill anything.", "Well. There is little we can do unless we find her."
   };
   private static final String[] FVSeventyMinus1 = new String[]{
      "@There is a rumour among the wolves that she is alive.",
      "Yes. She has changed.",
      "They say that she ordered one of them dead.",
      "Yes. One would think so but I believe them.",
      "Obviously she does not want to be found."
   };
   private static final String[] VFSeventyMinus2 = new String[]{
      "@These.. newcomers.. their presence is related to the second visit.",
      "More leaked when she moved it.",
      "Please do. I will as well, and I will talk to Magranon.",
      "So will I.",
      "Nothing. She was moved far away."
   };
   private static final String[] FVSeventyMinus2 = new String[]{
      "",
      "Yes. Something opened up and they entered our forest.",
      "Oh. I will see if I can find a way to stop it.",
      "I will welcome them for now.",
      "Have you heard anything about her whereabouts?"
   };
   private static final String[] MLSeventyMinus1 = new String[]{
      "@Speak, wretch! What is your name and what do you do here?",
      "Hahaha! I heard she is nothing more than some kind of larvae!",
      "How?",
      "Is that so? What more?",
      "An altar? An altar.."
   };
   private static final String[] LMSeventyMinus1 = new String[]{
      "",
      "I am Baghmot. I speak on behalf of Her. I am to tell you that you will be undone!",
   ...
   private static final String[] MLSeventyMinus2 = new String[]{
      "@Do you like my fire?",
   ...
   private static final String[] LMSeventyMinus2 = new String[]{
      "",
      "It hurts! Aiii!",
   ...
   private static final String[] FMSeventyMinus1 = new String[]{
      "",
      "Me and Vynora is going to welcome them while we figure out a way.",
      "Build an altar?",
      "I gathered some of it that was dropped as she left. Maybe it will protect our altar.",
      "Vynora learned their language. She can make inscriptions.",
      "Please reconsider. We need to unite.",
      "So be it then."
   };
   private static final String[] MFSeventyMinus1 = new String[]{
      "@She is building an altar. The newcomers give her strength.",
      "We should do the same then.",
      "Yes. I tried to approach hers. It is full with her tainted source. It hurts to approach.",
      "Yes.. Maybe it will. We can try.",
      "I have as well, and I have my own plans. I will write my own inscription.",
      "I have had time."
   };
   private static final String[] FMSeventyMinus2 = new String[]{
      "@Spirits come to me daily now.",
      "Yes. What can I say?",
      "Why? He will not love you anyways.",
      "I will not cast him out. I fear that it would ruin him.",
   ...
   private static final String[] MFSeventyMinus2 = new String[]{
      "",
      "I have noticed such a change. Also my brother no longer speaks with me. He loves you instead.",
      "It hurts. You could refuse him.",
      "You do not know that.",
      "I made them from spirits. What about them?",
      "They do not! There are worse matters that YOU are the cause of!",
      "I sense ignorance and insinuation. I will react negatively.",
      "I have found other powers. You have no idea."
   };
   private static final String[] VMSeventyMinus1 = new String[]{
   ...
   private static final String[] MVSeventyMinus1 = new String[]{
      "",
      "Yes I am aware that she did. They should not have told you. It is treason.",
      "Why?",
      "No you do not. In any case you found out.",
      "That is fine with me.",
      "Nothing ever stays the same, does it?"
   };
   private static final String[] VMSeventyMinus2 = new String[]{
      "",
      ...
      "I am aware. They are probably doomed, then."
   };
   private static final String[] MVSeventyMinus2 = new String[]{
      "@That wretched wolf I told you about.",
      "He claimed that her lands are alive somehow.",
      "I had to go see for myself. Seems they are abundant with corrupt source.",
      "Yes I am sure it is. It is also spreading.",
      "What would you think can come from it?",
      "She has started to attract them.",
      "Let's hope not."
   };
   private static final String[] FLSeventyMinus1 = new String[]{
      "@What have you done?",
      "I saved your friend.",
   ...
   private static final String[] LFSeventyMinus1 = new String[]{
      "",
      "How did you find me?",
      "Haha. Friend you say?",
      "Of course. You manage to fool everyone.",
      "So you say. I know better.",
      "I will have no mercy with you, you know that.",
      "You are only regretful. You game went awry and now you are scared. Cowards.",
      "Guess what? LEAVE ME ALONE! ALONE!"
   };
   private static final String[] FLSeventyMinus2 = new String[]{
      "@Did we actually meet afterwards?",
      "Did you really say those things?",
      "I love you, don't I?",
      "I don't understand why they didn't stop me.",
      "Am I still?",
      "And mine, of course."
   };
   private static final String[] LFSeventyMinus2 = new String[]{
      "",
      "Who knows?",
      "Most probably.",
      "So they say.",
      "They probably couldn't. You were too powerful.",
      "I wouldn't think so. Depends on my followers.",
      "Yes. Yours as well."
   };
   private static final String[] VLSeventyMinus1 = new String[]{
      "@You are sleeping now aren't you?",
      "So I can reach you in your dreams only.",
      "Will you not end this then?",
      "We apologize.",
      "I can foresee the destruction you will cause.",
      "What can we offer?"
   };
   private static final String[] LVSeventyMinus1 = new String[]{
      "",
      "Yes I am.",
      "Yes. I will hide.",
   ...
   private static final String[] VLSeventyMinus2 = new String[]{
      "@I am back again.",
      "Can you lock me out do you think?",
      "Fascinating. Anyways, we have decided to offer you all the newcomers.",
      "Yes we would.",
      "If you say so. Anything else?",
      "We will be prepared."
   };
   private static final String[] LVSeventyMinus2 = new String[]{
      "",
      "You are not welcome. This is the last time.",
      "Yes. You are here only because I allow you to.",
      "That is not enough. Really sacrifice them?",
      "That is truly ruthless.",
      "No. This was the last time.",
      "I don't think so."
   };
   private static final String[] item1 = new String[]{
      "@Hello.", "Pleased to meet you.", "How are we today?", "Oh, nice.", "Yes yes YES!", "Hahaha!", "Take that!", "Bang!", "Tjoff!"
   };
   private static final String[] item2 = new String[]{
      "@Hi.",
      "Pleased to meet you too.",
      "Fine thanks?",
      "You were one ugly doll.",
      "Silence, please!",
      "Why do you say that?",
      "Ouch!",
      "Buhuhu!",
   ...
   private static final String[] item3 = new String[]{
      "@Woof!",
      "Bongo bongo bey.",
      "Lamisika!",
      "Hoodeladi hoppsan sa.",
      "You don't fool me, biscuit eater!",
      "Your ugly twin was by yesterday.",
      "He said he looked better than you.",
      "Don't hit me!",
      "Please calm down.",
      "I never said that!"
   };
   private static final String[] item4 = new String[]{
      "@How are you doing, friend?",
      "Nice to see you here.",
      "I really like the weather today. Do you think it will rain?",
      "How have you been lately?",
      "Glad to hear that.",
      "I am fine thank you. Very fine indeed."
   };
   private static final String[] item5 = new String[]{
      "@Aren't we the madhatter today?",
      "No I mean you!",
      "Help, guards!",
      "Guards!",
      "I am sure they will catch the perpetrator eventually.",
      "Who said that?",
      "No that's YOU!"
   };
   private static final String[] item6 = new String[]{
      "@Where are we?",
      "What are we doing here?",
      "You can't be serious.",
      "Who are you talking to?",
      "Please calm down!",
      "I am not upset but I can see that you are.",
      "That is your problem."
   };
   private static final String[] item7 = new String[]{
      "@Hello, dear friend.",
      "Yes it was too long.",
      "No I haven't.",
   ...
   private static final String[] item8 = new String[]{
      "@What is this place?",
   ...
   private static final String[] item9 = new String[]{
   ...
   private static final String[] item10 = new String[]{
      "@Bla hello bla.",
      "I actually like Magranon.",
      "Magranon is the best.",
      "Magranon can kill ANYTHING.",
      "Magranon blows fire from his ass.",
      "I didn't mean to say that last thing. Now I blush.",
      "Who are you to question me anyways?"
   };
   private static final String[] item11 = new String[]{
      "@Hey, you!",
      "Are you Vynora?",
   ...
   private static final String[] item12 = new String[]{
      "@Who was that?",
      "Oh it was you!",
      "No",
   ...
   private static final String[] item13 = new String[]{
      "@Oh hi",
      "No I don't.",
      "Who are you anyways?",
      "That's me in a nutshell.",
      "Hey wonderboy, don't you grow tired of those remarks?",
      "I took old Sadking on a ride yesterday.",
      "He buckled so much and I fell off.",
      "I don't feel any differenk.",
      "Thank you, thank you very much."
   };
   private static final String[] item14 = new String[]{
      "@Hello again.",
      "Haven't we met?",
      "Take that, infidel!",
      "Who said that?",
   ...
   private static final String[] item15 = new String[]{
      "@Good day to you.",
      "Well, how nice.",
      "Ho ho ho.",
      ...
      "Oh, jolly.",
      "Jeeves! Jeeves!",
      "Please pour my cup of tea, dear.",
      "Most sorry if I upset anyone. Now take care, folks!"
   };
   private static final String[] item16 = new String[]{
      "@Wild thing! You make everything swing!",
      "Yeah!",
      "To the bottom, girls!",
      "Yumba, yumba - toot!",
      "That's right! Work it harder, dangerous one!",
      "You should meet my friend Spoon.",
      "That's all folks!"
   };
   private static final String[] FFbasic1 = new String[]{
      "@Fo.",
      "Yes.",
      "How am I today?",
      "Fine thank you.",
   ...
   private static final String[] MMbasic1 = new String[]{
   ...
   private static final String[] LLbasic1 = new String[]{
      "@I am Libila, slayer of good!",
      "I am the bottom and the end.",
      "I am the stone you crash upon and split open.",
      "No enemy survives me.",
      "Nothing endures me.",
      "I turn all to black and blood.",
      "In all my work you will see malevolence.",
      "I promise power and wealth to those who trust me.",
      "Would you trust me?"
   };
   private static final String[] VVbasic1 = new String[]{
      "@Vynora is my name.",
   ...
   private static final String[] FMbasic1 = new String[]{
      "@Hello Magranon.",
   ...
   private static final String[] MFbasic1 = new String[]{
      "", "Fo.", "Always strong. Always on the hunt!", "Hah! That's why I created them!", "No. For protection.", "Against Libila!", "She must be stopped."
   };
   private static final String[] FMbasic2 = new String[]{
      "",
      "Go ahead.",
   ...
   private static final String[] MFbasic2 = new String[]{
      "@I need your advice, Fo!",
      "I am in love with Vynora!",
   ...
   private static final String[] FLbasic1 = new String[]{
      "@Vile creature, begone!",
      "Do not come near me!",
      "Nooo! Aaah!",
      "Aaah!",
      "My creatures will stop you.",
      "You have no idea.",
      "No, they have strong hearts and souls!"
   };
   private static final String[] LFbasic1 = new String[]{
      "",
   ...
   private static final String[] FLbasic2 = new String[]{
      "@Libila! You will stay put! Bow before my might!",
      "I am the light! You will suffer in my presence!",
      "Change your ways, Libila.",
      "Do not hate. Hate will consume you.",
      "Then you will perish."
   };
   private static final String[] LFbasic2 = new String[]{
      "",
      "Yield! Yield to me!",
      "I am darkness! You will go blind and weak while with me.",
      "I will never! I hate you!",
      "Little do you know. I have mastered hate.",
      "I laugh at you. Hahaha!"
   };
   private static final String[] FVbasic1 = new String[]{
      "@Vynora, my friend.",
   ...
   private static final String[] VFbasic1 = new String[]{
      "",
      "Dear Fo.",
      "I know that the sun shines always beyond the clouds.",
      "You hide something from me, do you?",
      "I do not know. But my priests speak about it.",
      "Nevertheless, I will find them out."
   };
   private static final String[] FVbasic2 = new String[]{
      "", "I have met her.", "She was very forthcoming, if I may say.", "I will not elaborate. What do you insinuate?", "Don't get into deep water now!"
   };
   private static final String[] VFbasic2 = new String[]{
   ...
   private static final String[] MVbasic1 = new String[]{
      "",
      "Creatures?",
      "Yes. I made them.",
   ...
   private static final String[] VMbasic1 = new String[]{
      ...
      "I must figure that out as well then."
   };
   private static final String[] MVbasic2 = new String[]{
      "@Have you figured out how Libila creates her Zombies yet?",
      "I wonder if what she uses can be used some other way?",
      "That would be fun, haha!",
      "Armies of cottages to crush her zombies!",
      "Now you're talking!",
      "It sure would."
   };
   private static final String[] VMbasic2 = new String[]{
      "",
      "Not yet.",
      "Maybe. Maybe we could animate tables!",
      "Yes, and cottages.",
      "I could animate the sea and drown her lands!",
      "Well, it would suit me, wouldn't it?",
      "One day maybe. One day."
   };
   private static final String[] MLbasic1 = new String[]{
      "@Hello Libila. What are you doing here?",
      "Hah! I am the only hunter here!",
   ...
   private static final String[] LMbasic1 = new String[]{
      "",
      ...
      "Have you never wanted to hurt someone who laughs at you?",
   ...
   private static final String[] LMbasic2 = new String[]{
      "", "Ouch!", "Eek!", "Ow!", "Yes, please stop!", "Buhuhuu.", "Noo, noo! Have mercy!", "Yes Magranon! You win! You win!"
   };
   private static final String[] VLbasic1 = new String[]{
      "@Tell me your secrets!",
      "Then I will hurt you. Here!",
   ...
   private static final String[] LVbasic1 = new String[]{
      "",
      "Is this a joke? I will not!",
      "Ouch!",
   ...
   private static final String[] VLbasic2 = new String[]{
      "",
      "Yes. Here we are. This time I will have you!",
   ...
   private static final String[] LVbasic2 = new String[]{
      "@Aaand here we are again.",
      "No. Let's be friends.",
      "It is not a trap. Here, have some apple juice.",
      "Do not think about that. I used apples from the ground.",
      "Yes it still tastes wonderful - I tried it myself.",
      "Oh, look. You die. How sad.",
      "Yes, didn't I? Don't I always?",
      "I think not."
   };
   ...
   public static final int getConversationLength(
      boolean puppetOneStarted, Action act, Item puppetOne, Item puppetTwo, Creature performerOne, Creature performerTwo, int counter
   ) {
      ...
      int deityOne = getDeityFor(puppetOne);
      int deityTwo = getDeityFor(puppetTwo);
   ...
   public static final boolean sendConversationString(Action act, Item puppetOne, Item puppetTwo, Creature performerOne, Creature performerTwo, int counter) {
      ...
      if (!(
         puppeteering.skillCheck(
               (double)((float)counter * (3.0F - 0.2F * (float)puppetOne.getRarity() - 0.2F * (float)puppetTwo.getRarity()) + (courierOne + courierTwo) / 4.0F),
               puppetOne,
               0.0,
               false,
               5.0F
   ...
   private static final void sendFailString(Creature performer, Item puppet, float enchantLevel, int puppetDeity) {
      ...
      switch(failType) {
         case 0:
            ...
            if (puppet.isPuppet() && (float)Server.rand.nextInt(100) < enchantLevel) {
               red = true;
               int x = Server.rand.nextInt(10);
               if (x == 0) {
                  toSendPerformer = "The " + puppet.getName() + " glares at you!";
                  toSendBroadCast = performer.getName()
                     + " looks shocked as "
                  ...
                  toSendBroadCast = performer.getNamePossessive()
                     + " "
                     + puppet.getName()
                     + " gives "
                     + performer.getHimHerItString()
                     + " a dark, menacing look!";
               } else if (x == 3) {
                  ...
                  try {
                     ...
                     try {
                        ...
                        armour.setDamage(
                           armour.getDamage()
                              + Math.max(
                                 0.05F,
                                 Math.min(1.0F, 7000.0F * ArmourTemplate.getArmourDamageModFor(armour, (byte)3) / 1200000.0F * armour.getDamageModifier())
                              )
                        );
                     } catch (NoArmourException var13) {
                     ...
                     CombatEngine.addWound(
                        ...
                        (byte)3,
                        pos,
                        (double)(5000 + Server.rand.nextInt(10000)),
                        armourMod,
                        "bites",
                        null,
                        20.0F,
                        (float)Server.rand.nextInt((int)poisdam),
                        false,
                        false,
                        false,
                        false
   ...
   private static final String[] getConversationArrayFor(
      int actSeed, Item puppetOne, Item puppetTwo, int deityOne, int performerTypeOne, float courierOne, int deityTwo, int performerTypeTwo, float courierTwo
   ) {
      if (puppetOne.isPuppet() && puppetTwo.isPuppet() && courierOne > 70.0F && courierTwo > 70.0F) {
      ...
      } else if (puppetOne.isPuppet() && puppetTwo.isPuppet() && courierOne > 0.0F && courierTwo > 0.0F) {
         return getSeventyMinusArray(actSeed, deityOne, performerTypeOne, deityTwo, performerTypeTwo);
      } else if (!puppetOne.isPuppet() && puppetTwo.isPuppet() && courierTwo > 70.0F) {
         return getSeventyPlusItemArray(actSeed, deityOne, performerTypeOne, deityTwo, performerTypeTwo);
      } else if (!puppetOne.isPuppet() && puppetTwo.isPuppet()) {
         return getBasicItemArray(actSeed, deityOne, performerTypeOne, deityTwo, performerTypeTwo);
      } else if (puppetOne.isPuppet() && !puppetTwo.isPuppet() && courierOne > 70.0F) {
         return getSeventyPlusItemArray(actSeed, deityOne, performerTypeOne, deityTwo, performerTypeTwo);
      } else if (puppetOne.isPuppet() && !puppetTwo.isPuppet() && courierOne > 0.0F) {
         ...
         return puppetOne.isPuppet() && !puppetTwo.isPuppet() && courierOne == 0.0F
            ? getRandomDeityItemArray(actSeed, deityOne, performerTypeOne, deityTwo, performerTypeTwo)
            : emptyStringArray;
      }
   }
   ...
   public static final long getLastPuppeteered(long performerId) {
      ...
      if (last == null) {
         ...
         return System.currentTimeMillis() - last > 900000L ? 0L : last;
      }
   }
