...
public class ItemTemplateCreatorKingdom extends ItemTemplateCreator implements MonetaryConstants, MiscConstants, ModelConstants, ItemTypes {
   ...
   public static void initializeTemplates() throws IOException {
      createItemTemplate(
         ...
         "poor",
         "A high guard tower.",
         new short[]{52, 25, 31, 67, 44, 85, 86, 49, 98, 123, 194, 239},
         (short)60,
         (short)1,
         0,
         19353600L,
         ...
         600,
         -10,
         EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.guardtower.jenn.",
         20.0F,
         500000,
         (byte)15
      );
      createItemTemplate(
         ...
         -10,
         EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.guardtower.hots.",
         20.0F,
         500000,
         (byte)15
      );
      createItemTemplate(
         ...
         -10,
         EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.guardtower.molr.",
         20.0F,
         500000,
         (byte)15
      );
      createItemTemplate(
         ...
         -10,
         EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.guardtower.free.",
         20.0F,
         500000,
         (byte)15
      );
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A stone that can be claimed for your kingdom to apply a buff.",
         new short[]{108, 25, 31, 123, 52, 40, 98, 49, 109},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
