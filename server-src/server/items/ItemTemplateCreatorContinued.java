...
public class ItemTemplateCreatorContinued extends ItemTemplateCreator implements ModelConstants, ItemTypes {
   private static final Logger logger = Logger.getLogger(ItemTemplateCreatorContinued.class.getName());
   ...
   public static final void initializeTemplates() throws IOException {
      ...
      createItemTemplate(
         ...
         "half-full",
         "emptyish",
         "A devious trap made from sharp sticks that will be hard to detect in grass.",
         new short[]{132, 108, 147, 21, 44},
         (short)60,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
         ...
         "half-full",
         "emptyish",
         "A trap made from ropes and a sharp deadly pole.",
         new short[]{132, 108, 147, 21, 44},
         (short)60,
         (short)1,
         0,
      ...
      createItemTemplate(
         ...
         "half-full",
         "emptyish",
         "A very deadly trap, this one is made from a scythe blade hidden in masonry disguised as rock.",
         new short[]{132, 108, 147, 25, 44},
         (short)60,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
            ...
            new short[]{44, 147, 23, 136, 1, 180, 92, 139},
            (short)757,
            (short)1,
            0,
            3024000L,
         ...
         .setContainerSize(30, 40, 50)
         .addContainerRestriction(true, 1333, 1334);
      createItemTemplate(
         622,
         4,
         "saddle",
      ...
      createItemTemplate(
         ...
         new short[]{44, 147, 23, 136, 4, 92, 108},
         (short)1120,
         (short)1,
         0,
         3024000L,
      ...
      createItemTemplate(
         ...
         new short[]{44, 147, 22, 136, 4, 92, 108},
         (short)1120,
         (short)1,
         0,
         3024000L,
      ...
      createItemTemplate(
         ...
         new short[]{108, 147, 44, 23, 92, 136},
         (short)917,
         (short)1,
         0,
         3024000L,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A small bag or pouch, used in the creation of other items.",
         new short[]{44, 147, 23},
         (short)242,
         (short)1,
         0,
      ...
      createItemTemplate(
         ...
         "ok",
         "fragile",
         "A pair of bags that may be added to a saddle.",
         new short[]{44, 147, 23, 1, 248, 92, 139},
         (short)242,
         (short)1,
         0,
         3024000L,
      ...
      createItemTemplate(
         ...
         "ok",
         "fragile",
         "A pair of sacks that look like they may fit on a saddle. A special gift from Santa.",
         new short[]{44, 157, 23, 1, 187, 139},
         (short)242,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A hand puppet made from cloth and yarn.",
         new short[]{24, 44, 138, 157},
         (short)306,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
         ...
         new short[]{108, 31, 51, 52, 67, 86, 157, 92, 237},
         (short)60,
         (short)1,
         0,
         604800L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.statue.snowman.",
         5.0F,
         150000,
         (byte)26
      );
      createItemTemplate(
         ...
         new short[]{21, 113, 157, 52, 129, 237},
         (short)606,
         (short)1,
         20,
         604800L,
         ...
         1020,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.tree.christmas.",
         1.0F,
         15000,
         (byte)37
      );
      createItemTemplate(
         ...
         new short[]{108, 51, 52, 67, 92, 89, 1, 33, 40, 178},
         (short)60,
         (short)1,
         0,
         604800L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.statue.garden.",
         300.0F,
         20000,
         (byte)18
      );
      createItemTemplate(
         ...
         new short[]{108, 147, 135, 144, 21, 51, 52, 44, 47, 1, 92, 145, 176, 48, 199},
         (short)468,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.storagebin.food.",
         10.0F,
         20000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{108, 135, 1, 31, 21, 47, 51, 52, 53, 127, 176, 259},
         (short)244,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.chest.large.magical.",
         10.0F,
         15000,
         (byte)14,
         500000,
      ...
      createItemTemplate(
         ...
         new short[]{108, 135, 1, 21, 47, 51, 52, 53, 127, 259},
         (short)244,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.chest.small.magical.",
         10.0F,
         3000,
         (byte)14,
         250000,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "This silver tuning fork can be used one time to calculate the max qualitylevel and amount of ore left in an ore deposit.",
         new short[]{42, 22, 53, 127},
         (short)739,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         new short[]{108, 147, 21, 135, 144, 109, 31, 51, 52, 44, 1, 92},
         (short)60,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.storagebin.trash.",
         1.0F,
         20000,
         (byte)14,
         1,
      ...
      createItemTemplate(
         ...
         new short[]{38, 25, 17, 13, 11, 97, 151, 113},
         (short)1201,
         (short)1,
         1,
         3024000L,
      ...
      createItemTemplate(
         ...
         new short[]{38, 25, 10, 2, 97, 151, 113, 157, 247},
         (short)743,
         (short)1,
         3,
         9072000L,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.tool.pickaxe.blade.crude.",
         15.0F,
         2000,
         (byte)15,
         1,
      ...
      createItemTemplate(
         ...
         new short[]{38, 25, 37, 97, 15, 2, 151, 113, 157},
         (short)744,
         (short)1,
         3,
         9072000L,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.weapon.axe.small.blade.crude.",
         15.0F,
         2000,
         (byte)15,
         1,
      ...
      createItemTemplate(
         ...
         new short[]{133, 146, 21, 14, 144, 37, 84, 129, 151, 113, 175, 211},
         (short)646,
         (short)1,
         3,
         28800L,
      ...
      createItemTemplate(
         ...
         "poor",
         "A tool for digging.",
         new short[]{133, 38, 21, 19, 37, 2, 97, 151, 113, 157, 247},
         (short)746,
         (short)1,
         2,
         3024000L,
      ...
      createItemTemplate(
         ...
         new short[]{133, 146, 21, 14, 144, 37, 84, 129, 151, 113, 157},
         (short)646,
         (short)1,
         1,
         28800L,
      ...
      createItemTemplate(
         ...
         new short[]{21, 44, 1, 86, 52, 67, 31, 51, 199, 176, 178},
         (short)60,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.weapons.polearms.",
         15.0F,
         20000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.part.bell.huge.resonator.",
         60.0F,
         6300,
         (byte)31,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.bell.small.resonator.",
         60.0F,
         400,
         (byte)30,
         1000,
      ...
      createItemTemplate(
         ...
         new short[]{21, 44, 52, 31, 67, 109, 51, 178, 86, 176, 199},
         (short)310,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
         ...
         new short[]{25, 49, 31, 52, 44, 67, 109, 195, 194, 178, 123},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         new short[]{25, 49, 31, 52, 44, 67, 109, 178, 194, 195, 123},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         new short[]{25, 31, 52, 44, 67, 109, 51, 86, 178},
         (short)60,
         (short)1,
         0,
         12096000L,
      ...
      createItemTemplate(
         ...
         new short[]{25, 49, 31, 52, 44, 67, 195, 194, 109, 178, 123},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.pillar.foundation.",
         20.0F,
         1500000,
         (byte)15,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{25, 49, 31, 52, 40, 67, 98, 123, 48, 109, 178},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         new short[]{25, 49, 31, 52, 40, 98, 48, 123, 109, 178},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         "poor",
         "Within this ring of stones may the fate of kings and heroes be decided.",
         new short[]{25, 49, 31, 52, 40, 98, 48, 109, 123, 178},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.duelring.corner.",
         139.0F,
         100000,
         (byte)15,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{21, 113, 52, 129, 31, 123, 86, 237},
         (short)606,
         (short)1,
         20,
         86401L,
      ...
      createItemTemplate(
         ...
         new short[]{25, 49, 31, 52, 40, 67, 109, 123, 92, 48, 114, 32, 156, 60, 178},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         -10,
         new byte[]{29, 2, 36},
         "model.decoration.medallion.hota.",
         10.0F,
         70,
         (byte)7,
         4000,
      ...
      createItemTemplate(
         ...
         new short[]{49, 31, 52, 67, 98, 109, 123, 40, 114, 60, 178},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         new short[]{108, 22, 51, 52, 40, 67, 92, 1, 32, 48, 176, 199, 178, 259},
         (short)467,
         (short)1,
         0,
         12096000L,
      ...
      createItemTemplate(
         ...
         new short[]{108, 135, 144, 31, 1, 21, 86, 33, 51, 52, 44, 92, 109, 178, 176, 259},
         (short)245,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.barrel.huge.oil.",
         35.0F,
         60000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{21, 44, 1, 86, 52, 67, 31, 51, 135, 176, 178, 199},
         (short)60,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.weapons.armour.",
         20.0F,
         20000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "Some warriors have set up camp here.",
         new short[]{52, 21, 31, 67, 40, 49, 98, 48, 161, 178, 123},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         new short[]{31, 40, 25, 52, 67, 1, 33, 128, 123, 162, 178},
         (short)60,
         (short)1,
         0,
         12096000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.fountain.source.",
         40.0F,
         120000,
         (byte)15
      );
      createItemTemplate(
         ...
         "half-full",
         "emptyish",
         "A few stones glisten from the pinkish liquid known as the Source which emanates here.",
         new short[]{31, 40, 25, 52, 67, 1, 33, 128, 123, 162, 178},
         (short)60,
         (short)1,
         0,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.spring.source.",
         40.0F,
         120000,
         (byte)15
      );
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "This is a translucent pink, glittering crystal containing the Source - the essense of the future.",
         new short[]{93, 163},
         (short)542,
         (short)1,
         0,
      ...
      createItemTemplate(
         ...
         "half-full",
         "emptyish",
         "A small, carefully crafted wooden barrel which can be used for fermenting liquids.",
         new short[]{108, 135, 51, 1, 21, 33, 86, 52, 147, 44, 92, 77, 67, 178, 199, 236, 259},
         (short)245,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.winebarrel.small.",
         50.0F,
         2000,
         (byte)14,
         30000,
      ...
      createItemTemplate(
         ...
         new short[]{108, 44, 38, 21, 14, 119, 147},
         (short)862,
         (short)1,
         20,
         3024000L,
      ...
      createItemTemplate(
         ...
         new short[]{108, 135, 31, 21, 51, 86, 52, 44},
         (short)60,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.staircase.simple.",
         12.0F,
         35000,
         (byte)14,
         100,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A clay brick that could be hardened by fire.",
         new short[]{108, 146, 113, 129, 196},
         (short)574,
         (short)1,
         0,
         3024000L,
      ...
      createItemTemplate(
         ...
         new short[]{108, 30, 92, 147, 146, 242, 243},
         (short)575,
         (short)1,
         0,
         12096000L,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "Using this shiny golden mirror, you can change your gender and appearance.",
         new short[]{22, 40, 53, 127},
         (short)921,
         (short)1,
         10,
         3024000L,
      ...
      createItemTemplate(
         ...
         new short[]{25, 146, 46, 112, 113, 158, 247},
         (short)591,
         (short)1,
         0,
         18000L,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "Lots of different sized slate shards.",
         new short[]{25, 146, 46, 112, 113, 129, 48, 175},
         (short)610,
         (short)46,
         0,
         604800L,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "Lots of different sized marble shards.",
         new short[]{25, 146, 46, 112, 113, 129, 48, 175},
         (short)610,
         (short)46,
         0,
      ...
      createItemTemplate(
         ...
         "half-full",
         "emptyish",
         "A flat and square slate slab. It is about your length and width.",
         new short[]{25, 51, 135, 86, 44, 146, 158, 242, 243},
         (short)689,
         (short)1,
         0,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "An unfinished smelting pot that could be hardened by fire.",
         new short[]{108, 196, 44, 147},
         (short)491,
         (short)1,
         0,
         172800L,
      ...
      createItemTemplate(
         ...
         new short[]{25, 146, 113, 129, 196, 158},
         (short)576,
         (short)1,
         0,
         3024000L,
      ...
      createItemTemplate(
         ...
         new short[]{108, 44, 38, 22, 17, 13, 147},
         (short)1379,
         (short)1,
         1,
         3024000L,
         ...
         10029,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.weapon.knife.sacrificial.",
         30.0F,
         1230,
         (byte)8,
         2000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.weapon.blade.knife.sacrificial.",
         20.0F,
         1100,
         (byte)8,
         100,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.artifact.tomemagic.black.",
         1000.0F,
         1000,
         (byte)33,
         100000,
      ...
      createItemTemplate(
         ...
         "ok",
         "old",
         "The green leather covers will reveal the secrets of high magic for the one who dares open them.",
         new short[]{53, 168},
         (short)327,
         (short)1,
         0,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.artifact.tomemagic.green.",
         1000.0F,
         1000,
         (byte)33,
         100000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.artifact.tomemagic.white.",
         1000.0F,
         1000,
         (byte)33,
         100000,
      ...
      createItemTemplate(
         ...
         "old",
         "rotten",
         "This giant walnut has been picked on Valrei, home of the gods. Strange powers may dwell within!",
         new short[]{53, 168},
         (short)579,
         (short)1,
         0,
      ...
      createItemTemplate(
         ...
         new short[]{53, 168, 48, 143, 59, 199, 52},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A clay flowerpot that could be hardened by fire.",
         new short[]{108, 196, 44, 147},
         (short)490,
         (short)1,
         0,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.flowerpotYellow.",
         15.0F,
         600,
         (byte)19,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.flowerpotGreenish.",
         60.0F,
         600,
         (byte)19,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.flowerpotOrange.",
         25.0F,
         600,
         (byte)19,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.flowerpotPurple.",
         30.0F,
         600,
         (byte)19,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.flowerpotWhite.",
         35.0F,
         600,
         (byte)19,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.flowerpotDotted.",
         70.0F,
         600,
         (byte)19,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{25, 113, 144, 86, 119, 44},
         (short)335,
         (short)48,
         0,
         12096000L,
      ...
      createItemTemplate(
         ...
         "poor",
         "A gravestone to mark the final resting place of someone important.",
         new short[]{25, 31, 144, 86, 159, 51, 52, 44, 178},
         (short)335,
         (short)48,
         0,
         12096000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.gravestone.buried.",
         30.0F,
         20000,
         (byte)15,
         8,
      ...
      createItemTemplate(
         ...
         new short[]{133, 21, 14, 154, 144, 37, 84, 129, 172},
         (short)646,
         (short)1,
         35,
         9072000L,
         ...
         10090,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.weapon.polearm.staff.diamond.",
         10.0F,
         2000,
         (byte)14,
         100,
      ...
      createItemTemplate(
         ...
         10090,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.weapon.polearm.staff.opal.",
         10.0F,
         2000,
         (byte)14,
         100,
      ...
      createItemTemplate(
         ...
         10090,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.weapon.polearm.staff.ruby.",
         10.0F,
         2000,
         (byte)14,
         100,
      ...
      createItemTemplate(
         ...
         10090,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.weapon.polearm.staff.emerald.",
         10.0F,
         2000,
         (byte)14,
         100,
      ...
      createItemTemplate(
         ...
         10090,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.weapon.polearm.staff.sapphire.",
         10.0F,
         2000,
         (byte)14,
         100,
      ...
      createItemTemplate(
            ...
            new short[]{5, 21, 146, 80, 212, 217, 74},
            (short)579,
            (short)1,
            0,
            172800L,
         ...
         .setNutritionValues(6540, 137, 652, 152)
         .setFoodGroup(1197);
      createItemTemplate(
            833,
            "chestnut",
         ...
         .setNutritionValues(2000, 440, 13, 16)
         .setFoodGroup(1197);
      createItemTemplate(
         834,
         "yellow potion",
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "Seryll - this reddish metal is believed to exist naturally only on Seris, and be delivered here by envoys from the gods.",
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.brazier.stand.",
         60.0F,
         400,
         (byte)10,
         500,
      ...
      createItemTemplate(
         ...
         new short[]{22, 52, 44, 119, 32, 101, 179, 199, 51},
         (short)301,
         (short)1,
         0,
         3024000L,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.large.brazier.bowl.",
         60.0F,
         5000,
         (byte)7,
         10000,
      ...
      createItemTemplate(
         ...
         "marble brazier pillars",
         "fresh",
         "dry",
         "brittle",
         "rotten",
         "A pillar with a golden brazier on the top.",
         new short[]{25, 44, 119, 52, 199, 176, 32, 178, 101, 179, 51, 86},
         (short)60,
         (short)1,
         0,
         12096000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.brazier.pillar.",
         60.0F,
         855000,
         (byte)62,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{23, 44, 119, 52, 173, 51, 184},
         (short)603,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.brown.bear.rug.",
         50.0F,
         3000,
         (byte)55,
         20000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.black.bear.rug.",
         50.0F,
         3000,
         (byte)55,
         20000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.mountain.lion.rug.",
         50.0F,
         400,
         (byte)55,
         20000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.black.wolf.rug.",
         50.0F,
         3000,
         (byte)55,
         20000,
      ...
      createItemTemplate(
            ...
            new short[]{108, 135, 21, 48, 51, 52, 44, 1, 92, 145, 176},
            (short)311,
            (short)1,
            0,
            9072000L,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.light.snowlantern.seasoncycle.",
         20.0F,
         2500,
         (byte)21,
         70000,
      ...
      createItemTemplate(
            ...
            new short[]{108, 1, 31, 21, 51, 56, 52, 44, 92, 117, 54, 134, 193, 47, 160},
            (short)60,
            (short)41,
            0,
            9072000L,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.transports.large.ship.transporter.",
            30.0F,
            240000,
            (byte)14,
            10000,
      ...
      createItemTemplate(
            1410,
            3,
            "creature transporter",
            "transporters",
            "almost full",
            "somewhat occupied",
            "half-full",
            "emptyish",
            "A cart designed to transport creature cages over land.",
            new short[]{108, 1, 31, 21, 51, 56, 52, 44, 92, 117, 54, 134, 193, 47, 160},
            (short)60,
            (short)41,
            0,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.transports.large.creature.transporter.",
            30.0F,
            240000,
            (byte)14,
            10000,
      ...
      createItemTemplate(
         ...
         "poor",
         "",
         new short[]{108, 31, 51, 40, 52, 44, 48},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
            ...
            new short[]{108, 26, 88, 90, 213, 212},
            (short)582,
            (short)1,
            0,
            604800L,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.liquid.wine.rice.",
            70.0F,
            1000,
            (byte)26
         )
         .setAlcoholStrength(15);
      createItemTemplate(
         859,
         4,
         "chain link",
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.resource.largechain.iron.",
         28.0F,
         1000,
         (byte)11,
         2000,
      ...
      createItemTemplate(
            ...
            new short[]{24, 1, 47, 97, 181, 109, 201, 61, 52, 98, 180, 157},
            (short)640,
            (short)41,
            0,
            604800L,
      ...
      createItemTemplate(
         ...
         "faintly glowing",
         "barely glowing",
         "Blood from special creatures is said to have magic enchanting powers.",
         new short[]{6, 48},
         (short)582,
         (short)1,
         0,
      ...
      createItemTemplate(
         ...
         new short[]{108, 31, 25, 194, 135, 52, 44, 195, 67, 49, 123, 178, 157},
         (short)60,
         (short)1,
         0,
         12096000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.statue.colossus.vynora.",
         50.0F,
         7500000,
         (byte)15
      );
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.statue.colossus.magranon.",
         50.0F,
         7500000,
         (byte)15
      );
      ...
      createItemTemplate(
            ...
            new short[]{108, 21, 1, 135, 86, 199, 157, 51, 52, 44, 47, 92, 176, 180, 1, 180, 256},
            (short)60,
            (short)1,
            0,
            9072000L,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.furniture.wooden.bedside.table.",
            30.0F,
            10000,
            (byte)14,
            10000,
         ...
         .setContainerSize(30, 30, 50)
         .setContainerSize(40, 50, 50);
      createItemTemplate(
            889,
            3,
            "open fireplace",
            ...
            new short[]{108, 135, 31, 25, 51, 86, 52, 59, 44, 176, 1, 180, 256},
            (short)60,
            (short)18,
            0,
            12096000L,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.fireplace.open.decorative.",
            60.0F,
            100000,
            (byte)15,
            10000,
      ...
      createItemTemplate(
            ...
            new short[]{109, 108, 21, 51, 52, 44, 86, 31, 67, 135, 48, 110, 111, 176, 178, 1, 180, 256},
            (short)313,
            (short)1,
            0,
            9072000L,
      ...
      createItemTemplate(
         ...
         "half-full",
         "emptyish",
         "A comfortable wooden bench with wrought-iron decorations.",
         new short[]{108, 31, 135, 21, 86, 51, 52, 44, 199, 67, 176, 178, 117, 197},
         (short)60,
         (short)41,
         0,
         9072000L,
      ...
      createItemTemplate(
            ...
            new short[]{21, 44, 1, 86, 52, 67, 31, 51, 199, 176, 178, 180, 47},
            (short)60,
            (short)1,
            0,
            9072000L,
      ...
      createItemTemplate(
            ...
            "half-full",
            "emptyish",
            "A wooden coffer. Simple yet beautifully decorated.",
            new short[]{21, 44, 1, 86, 52, 67, 31, 51, 47, 176, 178, 199, 180, 259},
            (short)60,
            (short)1,
            0,
            9072000L,
      ...
      createItemTemplate(
         ...
         "poor",
         "A Royal Throne.",
         new short[]{109, 108, 21, 51, 52, 44, 86, 67, 135, 178, 117, 197, 199},
         (short)274,
         (short)41,
         0,
         9072000L,
      ...
      createItemTemplate(
            ...
            new short[]{22, 44, 1, 86, 52, 67, 51, 33, 178, 199, 180},
            (short)60,
            (short)1,
            0,
            3024000L,
      ...
      createItemTemplate(
            ...
            new short[]{21, 44, 86, 52, 67, 51, 157, 199, 178, 180, 51, 1, 180, 256},
            (short)60,
            (short)1,
            0,
            9072000L,
      ...
      createItemTemplate(
            ...
            new short[]{28, 5, 62, 129, 146, 76, 219, 212, 223},
            (short)503,
            (short)1,
            0,
            172800L,
         ...
         .setNutritionValues(970, 0, 15, 190)
         .setFoodGroup(1261);
      createItemTemplate(
         898,
         2,
      ...
      createItemTemplate(
         ...
         new short[]{21, 44, 119, 147, 199, 52},
         (short)776,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
         ...
         new short[]{25, 51, 135, 86, 44, 158, 147},
         (short)466,
         (short)1,
         0,
         12096000L,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.statue.colossus.fo.",
         50.0F,
         7500000,
         (byte)15
      );
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.colorful.carpet.small.",
         20.0F,
         3000,
         (byte)17,
         3000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.colorful.carpet.large.",
         40.0F,
         5000,
         (byte)17,
         5000,
      ...
      createItemTemplate(
            ...
            new short[]{21, 44, 52, 178, 67, 51, 199, 1, 180, 256},
            (short)60,
            (short)1,
            0,
            9072000L,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.decoration.high.bookshelf.",
            35.0F,
            30000,
            (byte)14,
            20000,
      ...
      createItemTemplate(
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.decoration.low.bookshelf.",
            25.0F,
            19000,
            (byte)14,
            10000,
      ...
      createItemTemplate(
            ...
            "ok",
            "poor",
            "A sharp looking empty bookshelf to store your special writings.",
            new short[]{21, 44, 52, 178, 67, 51, 199, 1, 180, 256},
            (short)60,
            (short)1,
            0,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.decoration.high.bookshelf.empty.",
            35.0F,
            30000,
            (byte)14,
            20000,
      ...
      createItemTemplate(
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.decoration.low.bookshelf.empty.",
            25.0F,
            19000,
            (byte)14,
            10000,
      ...
      createItemTemplate(
            ...
            "ok",
            "poor",
            "A large bar made for holding copious amounts of drinks.",
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.decoration.thirstyaussiebar.",
            35.0F,
            18000,
            (byte)14,
            10000,
      ...
      createItemTemplate(
            ...
            new short[]{21, 44, 52, 48, 67, 51, 117, 197, 178, 199, 249},
            (short)274,
            (short)41,
            0,
            9072000L,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.decoration.fine.high.chair.",
            60.0F,
            7500,
            (byte)14,
            30000,
      ...
      createItemTemplate(
         ...
         "poor",
         "A comfy looking chair which invites you to rest.",
         new short[]{21, 44, 52, 48, 67, 51, 117, 197, 178, 199},
         (short)274,
         (short)41,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.regular.high.chair.",
         50.0F,
         7000,
         (byte)14,
         20000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.pauper.high.chair.",
         25.0F,
         7000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.statue.colossus.libila.",
         50.0F,
         7500000,
         (byte)15
      );
      ...
      createItemTemplate(
         ...
         new short[]{108, 21, 52, 44, 86, 178, 51, 199, 167, 230},
         (short)420,
         (short)58,
         0,
         9072000L,
      ...
      createItemTemplate(
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.decoration.trellis.grape.",
            40.0F,
            5000,
            (byte)49
         )
      ...
      createItemTemplate(
         ...
         new short[]{108, 21, 51, 52, 44, 92, 86, 109, 176, 177, 113, 117, 157},
         (short)60,
         (short)40,
         0,
         9072000L,
         ...
         10093,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.small.ballista.",
         30.0F,
         70000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{108, 21, 51, 52, 44, 92, 86, 176, 113},
         (short)60,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
         ...
         new short[]{108, 1, 31, 63, 21, 51, 67, 52, 44, 92, 86, 109, 177, 113, 117, 178},
         (short)60,
         (short)40,
         0,
         9072000L,
         ...
         10094,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.small.trebuchet.",
         30.0F,
         1200000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{108, 31, 63, 21, 51, 67, 52, 44, 92, 86, 109, 177, 113, 56, 178},
         (short)60,
         (short)40,
         0,
         9072000L,
         ...
         1029,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.small.batteringram.",
         30.0F,
         200000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A large and heavy four-sided pyramidal head that will provide quite the punch.",
      ...
      createItemTemplate(
         ...
         new short[]{108, 21, 51, 52, 44, 86, 109, 176, 177, 113, 48, 199},
         (short)60,
         (short)1,
         0,
         9072000L,
         ...
         1029,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.small.pewpewdie.uncharged.",
         30.0F,
         150000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{108, 21, 51, 59, 52, 44, 86, 109, 176, 177, 113, 48, 199},
         (short)60,
         (short)1,
         0,
         9072000L,
         ...
         10044,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.small.pewpewdie.fire.",
         70.0F,
         150000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         10044,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.small.pewpewdie.lightning.",
         70.0F,
         150000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         10044,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.small.pewpewdie.frost.",
         70.0F,
         150000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         10044,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.small.pewpewdie.acid.",
         70.0F,
         150000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{21, 113, 52, 86, 109, 98, 51, 67, 31, 123},
         (short)606,
         (short)1,
         10,
         604800L,
      ...
      createItemTemplate(
         ...
         new short[]{21, 113, 52, 86, 109, 51, 98, 117, 31, 190},
         (short)606,
         (short)1,
         10,
         604800L,
      ...
      createItemTemplate(
         ...
         new short[]{52, 21, 31, 67, 44, 109, 86, 49, 98, 123, 59},
         (short)60,
         (short)1,
         0,
         19353600L,
      ...
      createItemTemplate(
         ...
         new short[]{21, 199, 52, 44, 86, 67, 51, 176, 108},
         (short)826,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
         ...
         new short[]{21, 44, 52, 86, 67, 51, 176, 178, 199},
         (short)274,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
            ...
            3,
            "royal lounge chaise",
            "royal lounge chaises",
            "excellent",
            "good",
            "ok",
            "poor",
            "Feel like the captain of a dragon ship while leaning back comfortably.",
            new short[]{21, 44, 52, 86, 67, 51, 176, 117, 197, 178, 199, 249},
            (short)274,
            (short)41,
            0,
            9072000L,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.furniture.chair.lounge.royal.",
            50.0F,
            10000,
            (byte)14,
            20000,
      ...
      createItemTemplate(
            ...
            new short[]{21, 44, 52, 47, 86, 67, 178, 51, 1, 199, 180, 176, 259},
            (short)60,
            (short)1,
            0,
            9072000L,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.furniture.wooden.cupboard.",
            50.0F,
            6500,
            (byte)14,
            10000,
      ...
      createItemTemplate(
         ...
         new short[]{30, 178, 33, 232, 1, 31, 229, 112, 240},
         (short)425,
         (short)1,
         0,
         Long.MAX_VALUE,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.pottery.thermos.",
         50.0F,
         250,
         (byte)19,
         100,
      ...
      createItemTemplate(
            ...
            "alchemist's cupboards",
            "excellent",
            "good",
            "ok",
            "poor",
            "A wooden cupboard, used to store small amounts of precious liquids.",
            new short[]{21, 178, 44, 52, 47, 86, 67, 51, 1, 199, 180, 176},
            (short)60,
            (short)1,
            0,
            9072000L,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.furniture.wooden.cupboard.alchemist.",
            50.0F,
            6500,
            (byte)14,
            10000,
         ...
         .setContainerSize(0, 0, 0)
         .setInitialContainers(
            new InitialContainer[]{
               new InitialContainer(1118, "vial", (byte)19),
               new InitialContainer(1118, "vial", (byte)19),
               new InitialContainer(1118, "vial", (byte)19),
               new InitialContainer(1118, "vial", (byte)19),
               new InitialContainer(1118, "vial", (byte)19),
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A shelf for storing things.",
         new short[]{21, 178, 232, 108, 1, 31, 229, 112, 240, 245},
         (short)626,
         (short)1,
         0,
         Long.MAX_VALUE,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.wooden.storageshelf.",
         40.0F,
         10000,
         (byte)14,
         100,
      ...
      createItemTemplate(
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.furniture.wooden.storageunit.",
            40.0F,
            200000,
            (byte)14,
            10000,
         ...
         .setContainerSize(0, 0, 0)
         .setInitialContainers(
            new InitialContainer[]{new InitialContainer(1120, "shelf"), new InitialContainer(1120, "shelf"), new InitialContainer(1120, "shelf")}
         )
         .setMaxItemCount(6);
      createItemTemplate(
            928,
            ...
            new short[]{108, 25, 44, 86, 52, 67, 51, 176, 199, 173, 178, 1, 180, 256},
            (short)60,
            (short)1,
            0,
            12096000L,
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.furniture.table.round.marble.",
            45.0F,
            80000,
            (byte)62,
            30000,
      ...
      createItemTemplate(
            ...
            -10,
            MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
            "model.furniture.table.square.marble.",
            45.0F,
            100000,
            (byte)62,
            30000,
      ...
      createItemTemplate(
         944,
         3,
         "yellow peasant wool cap",
         "yellow peasant wool caps",
         "excellent",
         "good",
         "ok",
         "poor",
         "A shabby yellow wool cap.",
         new short[]{108, 44, 24, 4, 147},
         (short)963,
         (short)1,
         0,
         3024000L,
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.cap0.yellow.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         945,
         3,
         "green peasant wool cap",
         "green peasant wool caps",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.cap0.green.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         946,
         3,
         "red peasant wool cap",
         "red peasant wool caps",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.cap0.red.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         947,
         3,
         "blue peasant wool cap",
         "blue peasant wool caps",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.cap0.blue.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         949,
         3,
         "dark common wool hat",
         "dark common wool hats",
         "excellent",
         "good",
         "ok",
         "poor",
         "A dark common wool hat for all weathers.",
         new short[]{108, 44, 24, 4, 157},
         (short)963,
         (short)1,
         0,
         3024000L,
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat1.dark.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         950,
         3,
         "brown common wool hat",
         "brown common wool hats",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat1.brown.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         951,
         3,
         "green common wool hat",
         "green common wool hats",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat1.green.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat1.red.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         953,
         3,
         "blue common wool hat",
         "blue common wool hats",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat1.blue.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         957,
         3,
         "blue foresters wool hat",
         "blue foresters wool hats",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat2.blue.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         956,
         3,
         "dark foresters wool hat",
         "dark foresters wool hats",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat2.dark.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         955,
         3,
         "green foresters wool hat",
         "green foresters wool hats",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat2.green.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         958,
         3,
         "red foresters wool hat",
         "red foresters wool hats",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat2.red.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.hat1.leather.",
         10.0F,
         400,
         (byte)16,
         10000,
      ...
      createItemTemplate(
         964,
         3,
         "black squire wool cap",
         "black squire wool caps",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat3.black.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         963,
         3,
         "blue squire wool cap",
         "blue squire wool caps",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat3.blue.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         962,
         3,
         "green squire wool cap",
         "green squire wool caps",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat3.green.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat3.red.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         966,
         3,
         "yellow squire wool cap",
         "yellow squire wool caps",
         "excellent",
         "good",
         "ok",
         "poor",
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.wool.hat3.yellow.",
         10.0F,
         300,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{108, 51, 52, 67, 1, 33, 40, 178},
         (short)60,
         (short)1,
         0,
         2419200L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.statue.garden.green.",
         300.0F,
         20000,
         (byte)18
      );
      createItemTemplate(
         ...
         new short[]{52, 21, 31, 67, 40, 49, 98, 48, 1, 178, 63},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.war.supplydepot.1.",
         100.0F,
         500000,
         (byte)0
      );
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.war.supplydepot.2.",
         100.0F,
         500000,
         (byte)0
      );
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.war.supplydepot.3.",
         100.0F,
         500000,
         (byte)0
      );
      ...
      createItemTemplate(
            ...
            -10,
            new byte[]{29},
            "model.armour.head.mask.enlightened.",
            25.0F,
            200,
            (byte)16,
            10000,
      ...
      createItemTemplate(
            ...
            -10,
            new byte[]{29},
            "model.armour.head.mask.ravager.",
            25.0F,
            200,
            (byte)16,
            10000,
      ...
      createItemTemplate(
            ...
            -10,
            new byte[]{29},
            "model.armour.head.mask.challenge.",
            25.0F,
            200,
            (byte)8,
            10000,
      ...
      createItemTemplate(
            ...
            "ok",
            "poor",
            "You can almost feel the mask is alive with little shoots among the leaves.",
            new short[]{108, 44, 22, 4, 187},
            (short)465,
            (short)1,
            0,
            ...
            -10,
            new byte[]{29},
            "model.armour.head.mask.midsummer.",
            25.0F,
            200,
            (byte)19,
            10000,
      ...
      createItemTemplate(
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.greathelmHornedOfGold.",
         25.0F,
         1700,
         (byte)9,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.openhelmplumedhunt.",
         15.0F,
         1100,
         (byte)9,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{108, 22, 51, 52, 40, 67, 176, 178, 187},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.statue.challenge.",
         15.0F,
         100000,
         (byte)7
      );
      ...
      createItemTemplate(
         ...
         new short[]{108, 25, 51, 52, 40, 67, 176, 178, 187},
         (short)60,
         (short)1,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         "old",
         "A HotA necklace.",
         new short[]{108, 52, 147, 22, 44, 87, 153, 187, 157},
         (short)268,
         (short)1,
         0,
         Long.MAX_VALUE,
         ...
         -10,
         new byte[]{29, 36},
         "model.decoration.necklace.hota.",
         40.0F,
         100,
         (byte)8,
         7000,
      ...
      createItemTemplate(
         ...
         new short[]{44, 133, 22, 14, 37, 84, 129, 187},
         (short)646,
         (short)1,
         45,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         " A stand used for making a tapestry.",
         new short[]{52, 21, 86, 119, 44, 67},
         (short)60,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.tapestry.stand.",
         30.0F,
         6000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A nice woven Tapestry made of wool with a green pattern.",
         new short[]{24, 52, 109, 86, 119, 44, 188, 157, 173, 51},
         (short)60,
         (short)1,
         0,
         9072000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.tapestry.pattern1.",
         30.0F,
         12000,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.tapestry.pattern2.",
         30.0F,
         12000,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.tapestry.pattern3.",
         30.0F,
         12000,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A nice woven Tapestry made of wool with a cavalry attack motif.",
         new short[]{24, 52, 109, 86, 119, 44, 188, 157, 173, 51},
         (short)60,
         (short)1,
         0,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.tapestry.motif1.",
         30.0F,
         12000,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.tapestry.motif2.",
         30.0F,
         12000,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A nice woven Tapestry made of wool with a motif showing the great battle of Kyara.",
         new short[]{24, 52, 109, 86, 119, 44, 188, 157, 173, 51},
         (short)60,
         (short)1,
         0,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.tapestry.motif3.",
         30.0F,
         12000,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A nice woven Tapestry made by Faeldray.",
         new short[]{24, 52, 109, 86, 119, 44, 188, 157, 173, 51},
         (short)60,
         (short)1,
         0,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.tapestry.faeldray.",
         30.0F,
         12000,
         (byte)69,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.container.chest.large.treasure.",
         210.0F,
         200000,
         (byte)14,
         10000,
      ...
      createItemTemplate(
         996,
         "neutral guard tower",
         "neutral guard towers",
         "excellent",
         "good",
         "ok",
         "poor",
         "A high guard tower.",
         new short[]{52, 25, 31, 67, 40, 49, 98, 123, 239},
         (short)60,
         (short)1,
         0,
         19353600L,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.furniture.valentineroses.",
         50.0F,
         600,
         (byte)19,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.greathelmWolf.",
         95.0F,
         1100,
         (byte)9,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{83, 40, 42, 48, 53, 54, 114},
         (short)321,
         (short)52,
         0,
         Long.MAX_VALUE,
      ...
      createItemTemplate(
         ...
         new short[]{108, 25, 52, 86, 119, 44, 176, 51, 199},
         (short)60,
         (short)47,
         0,
         12096000L,
      ...
      createItemTemplate(
         ...
         new short[]{108, 25, 169, 52, 86, 51, 199, 176},
         (short)60,
         (short)47,
         0,
         1382400L,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.planter.yellow.",
         15.0F,
         90000,
         (byte)62,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.planter.greenish.",
         60.0F,
         90000,
         (byte)62,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.planter.orange.",
         25.0F,
         90000,
         (byte)62,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.planter.purple.",
         30.0F,
         90000,
         (byte)62,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.planter.white.",
         35.0F,
         90000,
         (byte)62,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.planter.dotted.",
         70.0F,
         90000,
         (byte)62,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.artifact.tomemagic.incineration.",
         1000.0F,
         1000,
         (byte)33,
         100000,
      ...
      createItemTemplate(
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.goblin.war.bonnet.",
         15.0F,
         700,
         (byte)16,
         10000,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A mouldy cow head, with some fleshy bits still attached to it.",
         new short[]{108, 44, 23, 4, 157},
         (short)1003,
         (short)1,
         0,
         3024000L,
         ...
         -10,
         new byte[]{1, 28},
         "model.armour.head.troll.king.hat.",
         15.0F,
         700,
         (byte)16,
         10000,
      ...
      createItemTemplate(
         ...
         new short[]{108, 196, 44, 147, 1, 194, 63},
         (short)662,
         (short)1,
         0,
         172800L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.amphora.small.",
         50.0F,
         6000,
         (byte)18,
         100,
      ...
      createItemTemplate(
         ...
         new short[]{108, 30, 1, 33, 123, 195, 194, 52, 92, 215, 48},
         (short)682,
         (short)1,
         0,
         12096000L,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.amphora.large.",
         70.0F,
         12000,
         (byte)18,
         100,
      ...
      createItemTemplate(
         ...
         new short[]{52, 31, 1, 25, 51, 48, 59, 108, 176, 199, 109, 44, 119, 86, 67, 178, 209},
         (short)60,
         (short)18,
         0,
         12096000L,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A shiny gold coloured birdcage which looks like its made from brass.",
         new short[]{108, 147, 22, 44, 52, 51, 199},
         (short)361,
         (short)1,
         0,
         3024000L,
      ...
      createItemTemplate(
         ...
         new short[]{31, 135, 86, 6, 51, 52, 44, 67, 1, 33, 176, 178},
         (short)60,
         (short)1,
         0,
         12096000L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.decoration.rift.unstable.",
         40.0F,
         120000,
         (byte)21
      );
      ...
      createItemTemplate(
         ...
         new short[]{52, 31, 1, 25, 51, 48, 59, 108, 176, 199, 109, 44, 119, 86, 67, 178, 209, 259},
         (short)60,
         (short)18,
         0,
         12096000L,
      ...
      createItemTemplate(
         ...
         new short[]{108, 21, 147, 44, 52, 51, 199, 119, 86},
         (short)60,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
         ...
         new short[]{25, 49, 31, 52, 67, 86, 123, 178},
         (short)60,
         (short)1,
         0,
         604800L,
      ...
      createItemTemplate(
         ...
         new short[]{49, 31, 52, 67, 86, 123, 178},
         (short)60,
         (short)1,
         0,
         604800L,
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.rift.crystal.1.",
         99.0F,
         200000,
         (byte)52,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.rift.crystal.2.",
         99.0F,
         200000,
         (byte)52,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.rift.crystal.3.",
         99.0F,
         200000,
         (byte)52,
         10000,
      ...
      createItemTemplate(
         ...
         -10,
         MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY,
         "model.structure.rift.crystal.4.",
         99.0F,
         200000,
         (byte)52,
         10000,
      ...
      ItemTemplateCreatorThird.initializeTemplates();
      createItemTemplate(
         1097,
         "gift pack",
         "giftpacks",
         ...
         new short[]{53, 48, 108, 52, 21, 83, 42, 147, 157},
         (short)243,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
         ...
         "poor",
         "A gift pack containing something interesting.",
         new short[]{53, 48, 108, 52, 21, 83, 42, 157},
         (short)243,
         (short)1,
         0,
         9072000L,
      ...
      createItemTemplate(
         ...
         -10,
         new byte[]{29},
         "model.armour.head.mask.returner.",
         25.0F,
         200,
         (byte)16,
         10000,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "Some pieces of stone gathered from a defeated rift. Can be crafted together with metal to create a rune that will attach to stone, leather, cloth and pottery items.",
         new short[]{25, 146, 46, 112, 129, 48, 157},
         (short)610,
         (short)46,
         0,
         604800L,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "Some pieces of crystal gathered from a defeated rift. Can be crafted together with metal to create a rune that will attach to metal items.",
         new short[]{22, 146, 46, 112, 129, 48, 157},
         (short)60,
         (short)1,
         0,
         3024000L,
      ...
      createItemTemplate(
         ...
         new short[]{21, 146, 46, 112, 211, 129, 48, 157},
         (short)646,
         (short)1,
         10,
         28800L,
      ...
      createItemTemplate(
         ...
         "ok",
         "poor",
         "A fragment of another item. You think you can see how multiples of these fragments may fit together in a way that restores the original item.",
         new short[]{48, 157, 187, 233, 246},
         (short)1460,
         (short)1,
         0,
         12096000L,
      ...
      ItemTemplateCreatorKingdom.initializeTemplates();
   }
}
