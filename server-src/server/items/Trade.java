                  ...
                  if (shop != null && this.shopDiff != 0L) {
                     if (this.shopDiff > 0L) {
                        if (shop.getTax() > 0.0F
                           && !shop.isPersonal()
                           && citizenVillage != null
                           && this.creatureOne.citizenVillage != citizenVillage
                           && citizenVillage.plan != null) {
                           this.setTax((long)((float)this.shopDiff * shop.getTax()));
                           logger.log(
                              Level.INFO,
                              this.creatureOne.getName()
                                 + " and "
                                 + this.creatureTwo.getName()
                                 + " adding "
                                 + this.getTax()
                                 + " tax to "
                     ...
                     if (this.creatureOne.getPower() >= 5) {
                        this.creatureOne
                           ...
                           .sendNormalServerMessage(
                              "Shop setting money " + (shop.getMoney() + this.shopDiff - this.getTax()) + " (" + shop.getMoney() + " before)."
                           );
                     }
