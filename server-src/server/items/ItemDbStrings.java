...
public final class ItemDbStrings implements DbStrings {
   ...
   public String createData() {
      return DbConnector.isUseSqlite()
         ? "insert OR IGNORE into ITEMDATA ( DATA1, DATA2, EXTRA1, EXTRA2, WURMID) values(?,?,?,?,?)"
         : "insert IGNORE into ITEMDATA ( DATA1, DATA2, EXTRA1, EXTRA2, WURMID) values(?,?,?,?,?)";
   }
