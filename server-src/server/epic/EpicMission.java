...
public class EpicMission {
    ...
    private final void save() {
        ...
        try {
            ...
            ps = dbcon.prepareStatement(SAVE_EPIC_MISSION_ENTITY);
            ...
            try {
                logger.log(Level.WARNING, "Failed to save epic mission status.", sqx);
            }
    ...
    final void update() {
        ...
        try {
            dbcon = DbConnector.getDeityDbCon();
            ps = dbcon.prepareStatement(UPDATE_EPIC_MISSION_ENTITY);
            ...
            try {
                logger.log(Level.WARNING, "Failed to update epic mission progress.", sqx);
            }
            catch (Throwable throwable) {
                DbUtilities.closeDatabaseObjects(ps, null);
                DbConnector.returnConnection(dbcon);
    ...
    final void delete() {
        ...
        try {
            dbcon = DbConnector.getDeityDbCon();
            ps = dbcon.prepareStatement(DELETE_EPIC_MISSION);
            ...
            try {
                logger.log(Level.WARNING, "Failed to delete epic mission.", sqx);
            }
            catch (Throwable throwable) {
                DbUtilities.closeDatabaseObjects(ps, null);
                DbConnector.returnConnection(dbcon);
