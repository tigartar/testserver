         ...
         if (target.getQualityLevel() > 10.0F) {
            ...
            if (favorStored > 5) {
               ...
               try {
                  ...
                  logger.log(Level.WARNING, performer.getName() + ":" + var9.getMessage(), (Throwable)var9);
               }
               ...
               performer.getCommunicator()
                  .sendNormalServerMessage("You fail to store any favor but the " + target.getName() + " is damaged in the process.", (byte)3);
            }
         } else {
