        ...
        if (Servers.localServer.PVPSERVER) {
            ...
            if (Features.Feature.NEWDOMAINS.isEnabled()) {
                ...
                for (FaithZone f : Zones.getFaithZones()) {
                    if (f == null || f.getCurrentRuler().getTemplateDeity() != deity.getTemplateDeity()) continue;
                    try {
            ...
            for (Player lPlayer : players = Players.getInstance().getPlayers()) {
                if (lPlayer.getDeity() != null && lPlayer.getDeity().getTemplateDeity() == deity.getTemplateDeity()) continue;
