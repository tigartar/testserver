            ...
            public void run() {
               ...
               try {
                  ...
                  es.generateNewMissionForEpicEntity(
                     ...
                     WcCreateEpicMission.this.entityName,
                     WcCreateEpicMission.this.difficulty,
                     (int)WcCreateEpicMission.this.maxTimeSeconds,
                     WcCreateEpicMission.this.scenarioName,
                     WcCreateEpicMission.this.scenarioNumber,
                     WcCreateEpicMission.this.scenarioQuest,
                     WcCreateEpicMission.this.destroyPreviousMissions
                  );
               } catch (IOException var6) {
                  WcCreateEpicMission.logger.log(Level.WARNING, "Unpack exception " + var6.getMessage(), (Throwable)var6);
               } finally {
