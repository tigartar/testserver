        ...
        new Thread(){
            ...
            public void run() {
                if (Servers.isThisATestServer()) {
                    logger.log(Level.INFO, "Starting a global ignore.");
                }
                ...
                StreamUtilities.closeInputStreamIgnoreExceptions(dis);
                if (Servers.isThisATestServer()) {
                    logger.log(Level.INFO, WcGlobalIgnore.this.senderWurmId + "(" + WcGlobalIgnore.this.ignorerName + ") attempting ignore for " + WcGlobalIgnore.this.targetWurmId + " (" + WcGlobalIgnore.this.ignoreTarget + "), response=" + WcGlobalIgnore.this.response + ", Ignore=" + WcGlobalIgnore.this.startIgnore + ", UnIgnore=" + WcGlobalIgnore.this.startUnIgnore);
                }
                if (!WcGlobalIgnore.this.response) {
                    ...
                    if (pinf.loaded && (!Servers.isThisLoginServer() || pinf.getCurrentServer() == Servers.getLocalServerId())) {
                        if (WcGlobalIgnore.this.startUnIgnore) {
                            logger.log(Level.INFO, WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") unignoring " + WcGlobalIgnore.this.targetWurmId + " (" + WcGlobalIgnore.this.ignoreTarget + ")");
                            WcGlobalIgnore wgi = new WcGlobalIgnore(WurmId.getNextWCCommandId(), WcGlobalIgnore.this.senderWurmId, WcGlobalIgnore.this.ignorerName, pinf.wurmId, WcGlobalIgnore.this.ignoreTarget, true, false, WcGlobalIgnore.this.triggerMute, WcGlobalIgnore.this.startIgnore, WcGlobalIgnore.this.startUnIgnore, WcGlobalIgnore.this.ignorerKingdom);
                            wgi.sendToServer(WurmId.getOrigin(WcGlobalIgnore.this.getWurmId()));
                            return;
                        }
                        if (pinf.getPower() > 1 || pinf.mayMute) {
                            logger.log(Level.INFO, WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") Cannot ignore " + WcGlobalIgnore.this.targetWurmId + " (" + WcGlobalIgnore.this.ignoreTarget + ") as they can mute.");
                        ...
                        if (WcGlobalIgnore.this.triggerMute) {
                            logger.log(Level.INFO, WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") triggered muting for " + WcGlobalIgnore.this.ignoreTarget + "=" + WcGlobalIgnore.this.triggerMute);
                            Communicator.attemptMuting(WcGlobalIgnore.this.ignorerKingdom, pinf);
                        }
                        logger.log(Level.INFO, WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") sending response back to server " + WurmId.getOrigin(WcGlobalIgnore.this.getWurmId()));
                        WcGlobalIgnore wgi = new WcGlobalIgnore(WurmId.getNextWCCommandId(), WcGlobalIgnore.this.senderWurmId, WcGlobalIgnore.this.ignorerName, pinf.wurmId, WcGlobalIgnore.this.ignoreTarget, true, false, WcGlobalIgnore.this.triggerMute, WcGlobalIgnore.this.startIgnore, WcGlobalIgnore.this.startUnIgnore, WcGlobalIgnore.this.ignorerKingdom);
                        wgi.sendToServer(WurmId.getOrigin(WcGlobalIgnore.this.getWurmId()));
                    } else if (Servers.isThisLoginServer() && pinf.loaded) {
                        logger.log(Level.INFO, WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") redirecting of  " + WcGlobalIgnore.this.targetWurmId + " (" + WcGlobalIgnore.this.ignoreTarget + ") to " + pinf.getCurrentServer());
                        WcGlobalIgnore wgi = new WcGlobalIgnore(WcGlobalIgnore.this.getWurmId(), WcGlobalIgnore.this.senderWurmId, WcGlobalIgnore.this.ignorerName, WcGlobalIgnore.this.targetWurmId, WcGlobalIgnore.this.ignoreTarget, false, false, WcGlobalIgnore.this.triggerMute, WcGlobalIgnore.this.startIgnore, WcGlobalIgnore.this.startUnIgnore, WcGlobalIgnore.this.ignorerKingdom);
                        wgi.sendToServer(pinf.getCurrentServer());
                    } else if (!pinf.loaded) {
                        logger.log(Level.INFO, WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") sending response back to server as cannot find player " + WurmId.getOrigin(WcGlobalIgnore.this.getWurmId()));
                        WcGlobalIgnore wgi = new WcGlobalIgnore(WurmId.getNextWCCommandId(), WcGlobalIgnore.this.senderWurmId, WcGlobalIgnore.this.ignorerName, WcGlobalIgnore.this.targetWurmId, WcGlobalIgnore.this.ignoreTarget, true, false, WcGlobalIgnore.this.triggerMute, WcGlobalIgnore.this.startUnIgnore, WcGlobalIgnore.this.startUnIgnore, WcGlobalIgnore.this.ignorerKingdom);
                        wgi.sendToServer(WurmId.getOrigin(WcGlobalIgnore.this.getWurmId()));
                    }
                } else {
                    logger.log(Level.INFO, WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") receiving ignore response for " + WcGlobalIgnore.this.targetWurmId);
                    PlayerInfo pinf = PlayerInfoFactory.getPlayerInfoWithWurmId(WcGlobalIgnore.this.senderWurmId);
                    String toSend = "";
                    if (WcGlobalIgnore.this.cant) {
                        toSend = WcGlobalIgnore.this.startIgnore ? "You may not ignore " + WcGlobalIgnore.this.ignoreTarget + '.' : "You may not snipe " + WcGlobalIgnore.this.ignoreTarget + '.';
                        ...
                        try {
                            ...
                            logger.log(Level.WARNING, "Failed to add ignored for " + WcGlobalIgnore.this.ignoreTarget, e);
                    ...
                    Message mess = new Message(null, 17, ":Event", toSend);
