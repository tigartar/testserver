...
implements MiscConstants {
    ...
    private static final Map<Integer, OldMission> wlmissions = new HashMap<Integer, OldMission>();
    private static final Map<Integer, OldMission> blmissions = new HashMap<Integer, OldMission>();
    ...
    public static OldMission getMission(int num, byte kingdom) {
        if (kingdom == 3) {
            return blmissions.get(num);
        }
        return wlmissions.get(num);
    }

    private static void createMissions() {
        long start = System.currentTimeMillis();
        OldMission mj0 = new OldMission(0, 1);
        ...
        OldMission ml0 = new OldMission(0, 3);
        ...
        OldMission mj1 = new OldMission(1, 1);
        mj1.title = "Equipping";
        ...
        OldMission ml1 = new OldMission(1, 3);
        ml1.title = "Equipping";
        ...
        OldMission mj2 = new OldMission(2, 1);
        mj2.title = "Wearing";
        ...
        OldMission ml2 = new OldMission(2, 3);
        ml2.title = "Wearing";
        ...
        OldMission mj3 = new OldMission(3, 1);
        ...
        OldMission ml3 = new OldMission(3, 3);
        ...
        OldMission mj4 = new OldMission(4, 1);
        ...
        OldMission ml4 = new OldMission(4, 3);
        ...
        m = new OldMission(7, 3);
        m.title = "The bartender";
        m.missionDescription = "There is a bartender around here somewhere. Go find him and ask for refreshments.";
        m.missionDescription2 = "You will receive free refreshments the first 24 hours here.";
        m.missionDescription3 = "This means that you have a good reason to stay closeby and start learning things.";
        m = new OldMission(8, 1);
        m.title = "Digging";
        ...
        m = new OldMission(8, 3);
        m.title = "Digging";
        m.missionDescription = "A very common way to find resources like clay is to use a shovel and dig.";
        m.missionDescription2 = "You also need to flatten land in order to build on it.";
        m.missionDescription3 = "Go out and dig some dirt now. Drop the dirt before returning since it is pretty heavy to carry around.";
        m = new OldMission(9, 1);
        m.title = "Planks";
        ...
        OldMission ml9999 = new OldMission(9999, 3);
        ...
        OldMission mj9999 = new OldMission(9999, 1);
        ...
        logger.info("Finished creating " + wlmissions.size() + " WL and " + blmissions.size() + " BL Tutorial Missions, that took " + (System.currentTimeMillis() - start) + " ms");
    }

    static {
        OldMission.createMissions();
    }
}
