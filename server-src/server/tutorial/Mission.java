...
public class Mission implements Comparable<Mission> {
   ...
   Mission(
      ...
      String aInstruction,
      boolean aInActive,
      String aMissionCreatorName,
      String aCreatedDate,
      String aLastModifierName,
      Timestamp aLastModifiedDate,
      int aMaxTimeSeconds,
      boolean aMayBeRestarted
   ) {
      this.id = aId;
      this.name = aName;
   ...
   public String getOwnerName() {
      return this.getCreatorType() == 2 ? "System" : PlayerInfoFactory.getPlayerName(this.getOwnerId());
   }
   ...
   public String getLastModifiedDate() {
      return this.lastModifiedDate != null ? DateFormat.getDateInstance(2).format(this.lastModifiedDate) : "";
   }
   ...
   public final void update() {
      ...
      try {
         ...
         ps = dbcon.prepareStatement(
            "UPDATE MISSIONS SET NAME=?,INSTRUCTION=?,INACTIVE=?,CREATOR=?,CREATEDDATE=?,LASTMODIFIER=?,MAXTIMESECS=?,SECONDCHANCE=?,MAYBERESTARTED=?,FAILONDEATH=?,GROUP_NAME=?,HIDDEN=? WHERE ID=?"
         );
   ...
   public final void create() {
      ...
      try {
         dbcon = DbConnector.getPlayerDbCon();
         ps = dbcon.prepareStatement(
            "INSERT INTO MISSIONS (NAME,INSTRUCTION,INACTIVE,CREATOR,CREATEDDATE,LASTMODIFIER,MAXTIMESECS,SECONDCHANCE,MAYBERESTARTED,CREATORID,CREATORTYPE,FAILONDEATH,GROUP_NAME,HIDDEN) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
            1
         );
         ps.setString(1, this.name);
         ps.setString(2, this.instruction);
   ...
   public String toString() {
      return "Mission [createdDate="
         + this.createdDate
         + ", creatorType="
         + this.creatorType
         + ", hasSecondChance="
         + this.hasSecondChance
         + ", id="
         + this.id
         + ", inActive="
         + this.inActive
   ...
   public String getRewards() {
      ...
      return em != null ? em.getRewards() : "Unknown";
   }

   public byte getDifficulty() {
      EpicMission em = EpicServerStatus.getEpicMissionForMission(this.id);
      return em != null ? (byte)em.getDifficulty() : -10;
   }
