...
public class WelcomeStage extends TutorialStage {
   ...
   public class WelcomeSubStage extends TutorialStage.TutorialSubStage {
      ...
      protected void buildBMLString() {
         BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
            BMLBuilder.createCenteredNode(BMLBuilder.createVertArrayNode(false).addText("").addHeader("Welcome to Wurm!", Color.LIGHT_GRAY)),
            null,
            ...
            BMLBuilder.createLeftAlignedNode(
               BMLBuilder.createHorizArrayNode(false)
                  ...
                  .maybeAddSkipButton(Players.getInstance().getPlayerOrNull(this.getPlayerId()), true)
            )
         );
