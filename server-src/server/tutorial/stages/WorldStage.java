...
public class WorldStage extends TutorialStage {
   ...
   public class InteractSubStage extends TutorialStage.TutorialSubStage {
      ...
      protected void buildBMLString() {
         BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
            BMLBuilder.createCenteredNode(BMLBuilder.createVertArrayNode(false).addText("").addHeader("World Interaction", Color.LIGHT_GRAY)),
            null,
   ...
   public class SelectSubStage extends TutorialStage.TutorialSubStage {
