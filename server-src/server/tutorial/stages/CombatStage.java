...
public class CombatStage extends TutorialStage {
   ...
   public class OutlineSubStage extends TutorialStage.TutorialSubStage {
      ...
      protected void buildBMLString() {
         BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
            BMLBuilder.createCenteredNode(BMLBuilder.createVertArrayNode(false).addText("").addHeader("Combat", Color.LIGHT_GRAY)),
            null,
   ...
   public class SimpleSubStage extends TutorialStage.TutorialSubStage {
   ...
   public class TargetSubStage extends TutorialStage.TutorialSubStage {
   ...
   public class WarningSubStage extends TutorialStage.TutorialSubStage {
