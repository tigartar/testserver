...
public class RodFishingStage extends TutorialStage {
   ...
   public class RodActionSubStage extends TutorialStage.TutorialSubStage {
      ...
      protected void buildBMLString() {
         BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
            BMLBuilder.createCenteredNode(BMLBuilder.createVertArrayNode(false).addText("").addHeader("Pole/Rod Fishing", Color.LIGHT_GRAY)),
            null,
            BMLBuilder.createScrollPanelNode(true, false)
               .addString(
                  BMLBuilder.createVertArrayNode(false)
                     ...
                     .addImage("image.tutorial.fishing.casting", 300, 150)
   ...
   public class RodHookingSubStage extends TutorialStage.TutorialSubStage {
            ...
            BMLBuilder.createScrollPanelNode(true, false)
               .addString(
                  BMLBuilder.createVertArrayNode(false)
                     ...
                     .addImage("image.tutorial.fishing.reeling", 300, 150)
                     .addText(
   ...
   public class RodSetupSubStage extends TutorialStage.TutorialSubStage {
            ...
            BMLBuilder.createScrollPanelNode(true, false)
               .addString(
                  BMLBuilder.createVertArrayNode(false)
                     ...
                     .addImage("image.tutorial.fishing.rodinventory", 300, 150)
                     .addText(
   ...
   public class RodStartSubStage extends TutorialStage.TutorialSubStage {
