...
public class MiningStage extends TutorialStage {
   ...
   public class DigRockSubStage extends TutorialStage.TutorialSubStage {
      ...
      protected void buildBMLString() {
         BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
            BMLBuilder.createCenteredNode(BMLBuilder.createVertArrayNode(false).addText("").addHeader("Mining", Color.LIGHT_GRAY)),
            null,
   ...
   public class MineIronSubStage extends TutorialStage.TutorialSubStage {
