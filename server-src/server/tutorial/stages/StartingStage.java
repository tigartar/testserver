...
public class StartingStage extends TutorialStage {
   ...
   public class ChatSubStage extends TutorialStage.TutorialSubStage {
      ...
      protected void buildBMLString() {
         BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
            BMLBuilder.createCenteredNode(BMLBuilder.createVertArrayNode(false).addText("").addHeader("Starting Out", Color.LIGHT_GRAY)),
            null,
   ...
   public class DeathSubStage extends TutorialStage.TutorialSubStage {
   ...
   public class EventSubStage extends TutorialStage.TutorialSubStage {
   ...
   public class StartingInvSubStage extends TutorialStage.TutorialSubStage {
