...
public class EquipmentStage extends TutorialStage {
   ...
   public class ActivateSubStage extends TutorialStage.TutorialSubStage {
      ...
      protected void buildBMLString() {
         BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
            BMLBuilder.createCenteredNode(BMLBuilder.createVertArrayNode(false).addText("").addHeader("Activating & Equipping", Color.LIGHT_GRAY)),
            null,
   ...
   public class CharacterSubStage extends TutorialStage.TutorialSubStage {
   ...
   public class EquipSubStage extends TutorialStage.TutorialSubStage {
   ...
   public class ToolbeltSubStage extends TutorialStage.TutorialSubStage {
