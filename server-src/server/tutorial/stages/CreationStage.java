...
public class CreationStage extends TutorialStage {
   ...
   public class CreateCampfireSubStage extends TutorialStage.TutorialSubStage {
      ...
      protected void buildBMLString() {
         BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
            BMLBuilder.createCenteredNode(BMLBuilder.createVertArrayNode(false).addText("").addHeader("Creating Items", Color.LIGHT_GRAY)),
            null,
   ...
   public class CreateKindlingSubStage extends TutorialStage.TutorialSubStage {
   ...
   public class CreationWindowSubStage extends TutorialStage.TutorialSubStage {
