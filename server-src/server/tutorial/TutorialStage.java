...
public abstract class TutorialStage {
   ...
   public String getCurrentBML() {
      if (this.subStages == null) {
         ...
         return this.subStages.size() < this.getCurrentSubStage() ? ERROR_OVERSUBSTAGE : this.subStages.get(this.currentSubStage).getBMLString();
      }
   }
   ...
   public String getUpdateBML() {
      if (this.subStages == null) {
         ...
         return this.subStages.size() < this.getCurrentSubStage() ? ERROR_OVERSUBSTAGE_UPDATE : this.subStages.get(this.currentSubStage).getBMLUpdateString();
      }
   }
