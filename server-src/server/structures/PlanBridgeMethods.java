...
public final class PlanBridgeMethods implements MiscConstants {
   ...
   private static final int[] highest = new int[]{
      0,
      2,
      5,
      10,
   ...
   private static final int[] height24 = new int[]{
      1, 5, 12, 21, 32, 45, 60, 77, 95, 114, 133, 153, 173, 193, 212, 230, 247, 262, 275, 286, 295, 301, 305, 306
   };
   private static final int[] height25 = new int[]{
      1, 5, 11, 20, 30, 43, 58, 74, 91, 110, 129, 149, 169, 189, 208, 227, 245, 261, 275, 288, 299, 307, 314, 317, 319
   };
   private static final int[] height26 = new int[]{
      1, 5, 11, 19, 29, 42, 56, 72, 89, 107, 126, 146, 166, 186, 206, 225, 243, 260, 276, 290, 302, 313, 321, 327, 331, 332
   };
   private static final int[] height27 = new int[]{
      1, 5, 10, 18, 28, 40, 54, 69, 86, 104, 123, 142, 162, 182, 202, 221, 240, 258, 275, 290, 304, 316, 326, 334, 339, 343, 344
   };
   private static final int[] height28 = new int[]{
      1, 4, 10, 18, 27, 39, 52, 67, 84, 101, 120, 139, 159, 179, 199, 218, 238, 256, 274, 290, 305, 318, 330, 340, 347, 353, 356, 357
   };
   private static final int[] height29 = new int[]{
      1, 4, 10, 17, 26, 38, 51, 65, 81, 98, 116, 135, 155, 175, 195, 215, 234, 253, 271, 288, 304, 319, 332, 343, 352, 360, 365, 368, 369
   };
   private static final int[] height30 = new int[]{
      1, 4, 9, 17, 26, 37, 49, 63, 79, 96, 114, 132, 152, 171, 191, 211, 231, 250, 269, 287, 304, 319, 334, 346, 357, 366, 373, 378, 382, 383
   };
   private static final int[] height31 = new int[]{
      1, 4, 9, 16, 25, 35, 48, 61, 77, 93, 110, 129, 148, 168, 187, 207, 227, 247, 266, 284, 302, 318, 333, 347, 359, 370, 379, 386, 391, 394, 395
   };
   private static final int[] height32 = new int[]{
      1, 4, 9, 16, 24, 34, 46, 60, 75, 91, 108, 126, 145, 164, 184, 204, 224, 244, 263, 282, 300, 317, 333, 348, 362, 374, 384, 393, 399, 404, 407, 408
   };
   private static final int[] height33 = new int[]{
      1, 4, 9, 15, 23, 33, 45, 58, 73, 88, 105, 123, 141, 161, 180, 200, 220, 240, 260, 279, 297, 315, 332, 348, 362, 375, 387, 397, 405, 412, 417, 419, 420
   };
   private static final int[] height34 = new int[]{
      1,
      4,
      8,
      15,
   ...
   private static final int[] height35 = new int[]{
      1,
      4,
      8,
      14,
   ...
   private static final int[] height36 = new int[]{
      1,
      3,
      8,
      14,
   ...
   private static final int[] height37 = new int[]{
      1,
      3,
      8,
      13,
   ...
   private static final int[] height38 = new int[]{
      1,
      3,
      7,
      13,
   ...
   private static final int[] height39 = new int[]{
      1,
      3,
      7,
      13,
   ...
   private static final int[] height40 = new int[]{
      1,
      3,
      7,
      12,
   ...
   private static final int[] height41 = new int[]{
      1,
      3,
      7,
      12,
   ...
   private static final int[] height42 = new int[]{
      1,
      3,
      7,
      12,
   ...
   private static final int[] height43 = new int[]{
      1,
      3,
      7,
      12,
   ...
   private static final int[] height44 = new int[]{
      1,
      3,
      6,
      11,
   ...
   private static final int[] height45 = new int[]{
      1,
      3,
      6,
      11,
   ...
   private static final int[] height46 = new int[]{
      1,
      3,
      6,
      11,
   ...
   private static final int[] height47 = new int[]{
      1,
      3,
      6,
      11,
   ...
   private static final int[] height48 = new int[]{
      1,
      3,
      6,
      10,
   ...
   private static final int[] height49 = new int[]{
      1,
      3,
      6,
      10,
   ...
   private static final int[] height50 = new int[]{
      1,
      3,
      6,
      10,
   ...
   private static final int[][] heights = new int[][]{
      height0,
      height1,
      height2,
      height3,
   ...
   public static void planBridge(
      Creature performer, byte dir, byte bridgeType, boolean arched, String bridgePlan, int steepness, Point start, Point end, String bridgeName
   ) {
      ...
      int[] hts = calcHeights(performer, dir, bridgeType, arched, bridgePlan, steepness, start, end);
      boolean insta = performer.getPower() > 1;
      if (PlanBridgeChecks.passChecks(performer, start, end, dir, hts, insta)) {
         if (dir == 0) {
            ...
            for(int y = start.getY(); y <= end.getY(); ++y) {
               ...
               for(int x = start.getX(); x <= end.getX(); ++x) {
                  byte ndir = rdir;
                  BridgeConstants.BridgeType bridgetype = getBridgeType(dir, parts[yy], end.getX(), start.getX(), x, rdir);
                  if (!bridgetype.isAbutment() && !bridgetype.isBracing() && onLeft(dir, end.getX(), start.getX(), x, rdir)) {
                     ndir = (byte)((rdir + 4) % 8);
                  }

                  try {
                     VolaTile t = Zones.getOrCreateTile(x, y, layer == 0);
                     BridgePart bridgePart = new DbBridgePart(
                        bridgetype,
                        x,
                        y,
                        hts[yy],
                        1.0F,
                        performer.getStructure().getWurmId(),
                        BridgeConstants.BridgeMaterial.fromByte(bridgeType),
                        ndir,
                        slope,
                        northExit,
                        -1,
                  ...
                  } catch (NoSuchStructureException var28) {
            ...
            for(int x = start.getX(); x <= end.getX(); ++x) {
               for(int y = start.getY(); y <= end.getY(); ++y) {
                  try {
                     ...
                     performer.addStructureTile(t, (byte)1);
                     t.addBridge(performer.getStructure());
                  } catch (NoSuchStructureException var27) {
            ...
            for(int x = start.getX(); x <= end.getX(); ++x) {
               ...
               for(int y = start.getY(); y <= end.getY(); ++y) {
                  byte ndir = rdir;
                  BridgeConstants.BridgeType bridgetype = getBridgeType(dir, parts[xx], end.getY(), start.getY(), y, rdir);
                  if (!bridgetype.isAbutment() && !bridgetype.isBracing() && onLeft(dir, end.getY(), start.getY(), y, rdir)) {
                     ndir = (byte)((rdir + 4) % 8);
                  }
      ...
      if (arched) {
         if (bridgeType != BridgeConstants.BridgeMaterial.ROPE.getCode()) {
            ...
            if (bridge.length() == 1) {
               ...
               for(int x = 0; x < lenp1; ++x) {
                  if (tempBorders[x] > 0) {
                     borders[x] = tempBorders[x];
                  } else {
                     borders[x] = tempBorders[x] - odd;
                  }
               }

               for(int x = 0; x < lenp1; ++x) {
                  if (borders[x] >= 0) {
                     scale[x] = (float)borders[x] / (float)lowBorder;
                  } else {
                     scale[x] = (float)(-borders[x]) / (float)(hiBorder + odd);
                  }
               }

               for(int x = 0; x < lenp1; ++x) {
                  floatSag[x] = scaleFactor * Math.cosh((double)(scale[x] / 100.0F)) - scaleFactor - (double)sagDistance;
               }

               for(int x = 0; x < lenp1; ++x) {
                  tempSign[x] = Math.signum((float)borders[x]);
               }
               ...
               for(int x = 0; x < lenp1; ++x) {
                  if (htDiff >= 0) {
                     hts[x] = start.getH() + dirtSag[x];
                  } else {
                     hts[x] = end.getH() + oppSag[x];
                  }
               }
   ...
   public static int[] calcArch(Creature performer, int maxSlope, int len, Point start, Point end) {
      if (len == 1) {
         return new int[]{end.getH(), start.getH()};
      } else {
         ...
         if (performer.getPower() > 1 && DEBUG) {
            performer.getCommunicator()
               .sendNormalServerMessage("(len:" + len + " middle:" + middle + "," + lenn + " s:" + start.getH() + " e:" + end.getH() + ")");
         }
         ...
         if (performer.getPower() > 1 && DEBUG) {
            performer.getCommunicator()
               .sendNormalServerMessage("(middiff:" + closest + " L:" + Float.toString(slopeLeft) + " R:" + Float.toString(slopeRight) + ")");
         }
         ...
         for(int i = 0; i < middle; ++i) {
            hts[i + 1] = (int)((float)start.getH() + ((float)shts[i] - slopeLeftAdjustment) * factor);
         ...
         for(int i = 0; i < lenn; ++i) {
            hts[len - i - 1] = (int)((float)end.getH() + ((float)ehts[i] - slopeRightAdjustment) * factor);
      ...
      switch(part) {
         ...
         default:
            if (left == right) {
               ...
               return pos != left && pos != right ? BridgeConstants.BridgeType.FLOATING_CENTER : BridgeConstants.BridgeType.FLOATING_SIDE;
            }
      }
   }
   ...
   public static String[] isBuildingOk(byte bridgeType, byte dir, boolean onSurface, Point start, int startFloorlevel, Point end, int endFloorlevel) {
      if (dir == 0) {
         ...
         for(int x = start.getX(); x <= end.getX(); ++x) {
            VolaTile checkedTile = Zones.getTileOrNull(x, y - 1, onSurface);
            if (checkedTile != null) {
               ...
               String nos = noSupport(bridgeType, checkedTile, startFloorlevel, x, y, x + 1, y);
               if (nos.length() > 0) {
         ...
         for(int x = start.getX(); x <= end.getX(); ++x) {
            VolaTile checkedTile = Zones.getTileOrNull(x, y, onSurface);
            if (checkedTile != null) {
               ...
               String nos = noSupport(bridgeType, checkedTile, endFloorlevel, x, y, x + 1, y);
               if (nos.length() > 0) {
         ...
         for(int y = start.getY(); y <= end.getY(); ++y) {
            VolaTile checkedTile = Zones.getTileOrNull(x - 1, y, onSurface);
            if (checkedTile != null) {
               if (hasNoDoor(bridgeType, checkedTile, startFloorlevel, x, y, x, y + 1)) {
                  return new String[]{"W:No Door", "West end of bridge plan requires a door."};
               }

               String nos = noSupport(bridgeType, checkedTile, startFloorlevel, x, y, x, y + 1);
               if (nos.length() > 0) {
         ...
         for(int y = start.getY(); y <= end.getY(); ++y) {
            VolaTile checkedTile = Zones.getTileOrNull(x, y, onSurface);
            if (checkedTile != null) {
               if (hasNoDoor(bridgeType, checkedTile, endFloorlevel, x, y, x, y + 1)) {
                  return new String[]{"E:No Door", "East end of bridge plan requires a door."};
               }

               String nos = noSupport(bridgeType, checkedTile, endFloorlevel, x, y, x, y + 1);
               if (nos.length() > 0) {
   ...
   private static boolean hasNoDoor(byte bridgeType, VolaTile checkedTile, int floorlevel, int startX, int startY, int endX, int endY) {
      Wall wall = getWall(checkedTile, floorlevel, startX, startY, endX, endY);
   ...
   private static Wall getWall(VolaTile checkedTile, int floorlevel, int startX, int startY, int endX, int endY) {
      for(Wall wall : checkedTile.getWalls()) {
         if (wall.getFloorLevel() == floorlevel
