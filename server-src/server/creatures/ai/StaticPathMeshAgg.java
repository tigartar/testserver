    ...
    StaticPathMeshAgg(int startx, int starty, int endx, int endy, boolean surf, int borderSize, int[] aMesh) {
        ...
        for (int x = 0; x < this.sizex; ++x) {
            for (int y = 0; y < this.sizey; ++y) {
                StaticPathMeshAgg.pathables[x][y] = new PathTile(this.borderStartX + x, this.borderStartY + y, lMesh[this.borderStartX + x | this.borderStartY + y << Constants.meshSize], this.surfaced, (int)((byte)(this.surfaced ? 0 : -1)));
