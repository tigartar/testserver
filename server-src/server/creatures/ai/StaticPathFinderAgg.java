...
import com.wurmonline.server.creatures.ai.StaticPathMeshAgg;
...
implements MiscConstants {
    ...
    private static StaticPathMeshAgg mesh;
    ...
    int step2() {
        ...
        for (int i = 0; i < pathList.size(); ++i) {
            ...
            score += StaticPathFinderAgg.cbDist(now, this.finish, StaticPathFinderAgg.getCost(now.getTile()));
