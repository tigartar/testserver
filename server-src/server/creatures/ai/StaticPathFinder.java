...
public final class StaticPathFinder extends PathFinder implements MiscConstants {
   ...
   private static StaticPathMesh mesh = null;
   ...
   void setMesh() {
      ...
      mesh = new StaticPathMesh(this.startX, this.startY, this.endX, this.endY, this.surfaced, this.areaSize);
      ...
      if (!mesh.contains(x, y)) {
         ...
         if (this.stepsTaken > this.maxSteps) {
            ...
            throw new NoPathException(
               "Probably missed target using raycaster " + this.stepsTaken + " of " + this.maxSteps + " dx=" + this.derivX + ",dy=" + this.derivY
            );
         } else {
            ++this.stepsTaken;
            return toReturn;
