...
public interface AchievementList {
    ...
    public static final int ACH_CUTTREE_5 = 513;
    public static final int ACH_FLATTILE = 514;
    public static final int ACH_CREATE_MALLET = 515;
    public static final int ACH_MINE_IRON = 516;
    public static final int ACH_CREATE_NAILS = 517;
    public static final int ACH_PLAN_HOUSE = 518;
    public static final int ACH_BUILD_HOUSE = 519;
    public static final int ACH_IMP_METAL15 = 520;
    public static final int ACH_RIDE_COW = 521;
    public static final int ACH_KILL_CREATURE = 522;
    public static final int ACH_PLANT_CROP = 523;
    public static final int ACH_FIND_ROUTE = 524;
    public static final int ACH_BUILD_STONEWALL = 525;
    public static final int ACH_TAME_CREATURE = 526;
    public static final int ACH_MINE_COPPER = 527;
    public static final int ACH_MINE_TIN = 528;
    public static final int ACH_MINE_COPPERANDTIN = 529;
    public static final int ACH_CREATE_BRONZELUMP = 530;
    public static final int ACH_BREED_CREATURE = 531;
    public static final int ACH_CREATE_SMALLCART = 532;
    public static final int ACH_CREATE_FORGEOVEN = 533;
    public static final int ACH_CREATE_BREAKFAST = 534;
    public static final int ACH_RIDE_HORSE = 535;
    public static final int ACH_BANDAGE_WOUND = 536;
    public static final int ACH_PLANT_TREE = 537;
    public static final int ACH_CREATE_LARGECART = 538;
    public static final int ACH_BUILD_SECONDSTORY = 539;
    public static final int ACH_CREATE_BOAT = 540;
    public static final int ACH_CREATE_MEAL = 541;
    public static final int ACH_CATCH_FISH3KG = 542;
    public static final int ACH_IMP_TOOL50 = 543;
    public static final int ACH_HARVEST_COTTON5 = 544;
    public static final int ACH_RIDE_BEARBULL = 545;
    public static final int ACH_CREATE_HEALINGCOVER = 546;
    public static final int ACH_SLEEP_BED = 547;
    public static final int ACH_JOINPATH = 548;
    public static final int ACH_FOCUSL3 = 549;
    public static final int ACH_RESTORE_FRAGMENTS = 550;
    public static final int ACH_SLAY_TROLL = 551;
    public static final int ACH_OPEN_HIVE_SMOKER = 552;
    public static final int ACH_STUDY_TREEBUSH = 553;
    public static final int ACH_IMP_WEAP50 = 554;
    public static final int ACH_SKILL50 = 555;
    public static final int ACH_BECOME_FOLLOWER = 556;
    public static final int ACH_PLAN_BRIDGE = 557;
    public static final int ACH_PILOT_KNARR = 558;
    public static final int ACH_SPEAR_FISH = 559;
    public static final int ACH_MAKE_WINE = 560;
    public static final int ACH_CREATE_HALTER_ROPE = 561;
    public static final int ACH_FOCUSL5 = 562;
    public static final int ACH_TAUNT_CREATURE = 563;
    public static final int ACH_SKILL70 = 564;
    public static final int ACH_IMP_TOOL70 = 565;
    public static final int ACH_SLAY_GREENISH = 566;
    public static final int ACH_GET_DRUNK = 567;
    public static final int ACH_BECOME_DISEASED = 568;
    public static final int ACH_FAITH30 = 569;
    public static final int ACH_MEDITATEL4 = 570;
    public static final int ACH_BUILD_UNDERGROUND_HOUSE = 571;
    public static final int ACH_TITLES15 = 572;
    public static final int ACH_KILL_WITH_CATAPULT = 573;
    public static final int ACH_BUILD_GUARD_TOWER = 574;
    public static final int ACH_COMPLETE_ALMANAC = 575;
    public static final int ACH_VILLAGER = 576;
    public static final int ACH_SLAY_CHAMPION = 577;
    public static final int ACH_MEDITATEL7 = 578;
    public static final int ACH_TITLES30 = 579;
    public static final int ACH_ARCH_CACHE = 580;
    public static final int ACH_EQUIP_ENCHWEP = 581;
    public static final int ACH_MISSION10 = 582;
    public static final int ACH_CREATE_WAGON = 583;
    public static final int ACH_RIDE_FASTHORSE = 584;
    public static final int ACH_CATCH_FISH10KG = 585;
    public static final int ACH_USE_RUNE = 586;
    public static final int ACH_HARVEST_HERB50 = 587;
    public static final int ACH_SLAY_RIFTCREATURES = 588;
    public static final int ACH_SLAY_UNIQUE = 589;
    public static final int ACH_SKILL90 = 590;
    public static final int ACH_TITLES60 = 591;
    public static final int ACH_RESTORE_STATUE = 592;
    public static final int ACH_CREATE_RUNE10 = 593;
    public static final int ACH_RIDE_UNICORN = 594;
    public static final int ACH_MINE_80QL50 = 595;
    public static final int ACH_CREATE_BSGSTEW = 596;
    public static final int ACH_IMP_ARMOUR80 = 597;
    public static final int ACH_SKILL50_10 = 598;
    public static final int ACH_MEDITATEL9 = 599;
    public static final int ACH_SPAR10 = 600;
    public static final int ACH_MISSION1 = 601;
    public static final int ACH_PICKHERB = 602;
    public static final int ACH_MINE_80QL = 603;
    public static final int ACH_BECOME_PRIEST = 604;
    public static final int ACH_CHANNELING20 = 605;
    public static final int ACH_ITEM_ENCHANT = 606;
    public static final int ACH_ITEM_SACRIFICE = 607;
    public static final int ACH_FAITH40 = 608;
    public static final int ACH_PRAY_ITEM = 609;
    public static final int ACH_SERMON_LISTEN = 610;
    public static final int ACH_CRET_SACRIFICE = 611;
    public static final int ACH_CONFESSION_LISTEN = 612;
    public static final int ACH_FAVOR1K = 613;
    public static final int ACH_VESSEL = 614;
    public static final int ACH_LINKPRIEST = 615;
    public static final int ACH_ELECTRUM_STATUETTE = 616;
    public static final int ACH_CHANNELING50 = 617;
    public static final int ACH_FAITH70 = 618;
    public static final int ACH_SPELLCOST50 = 619;
    public static final int ACH_ITEM_SACRIFICE30F = 620;
    public static final int ACH_CONVERT_PLAYER = 621;
    public static final int ACH_PRAY_GEM = 622;
    public static final int ACH_SERMON10 = 623;
    public static final int ACH_ITEM_SACRIFICE1K = 624;
    public static final int ACH_VESSEL_DRAIN50F = 625;
    public static final int ACH_ALIGNMENTCAP = 626;
    public static final int ACH_ITEM_SHATTER = 627;
    public static final int ACH_CREATE_GOLDALTAR = 628;
    public static final int ACH_SPELL95P = 629;
    public static final int ACH_FAITH90 = 630;
    public static final int ACH_ITEM_SACRIFICE10K = 631;
    public static final int ACH_SERMON100 = 632;
    public static final int ACH_PRAYER70 = 633;
    public static final int ACH_CRET_SACRIFICECHAMP = 634;
    public static final int ACH_CAST_GLOBAL = 635;
    public static final int ACH_FAVOR100K = 636;
    public static final int ACH_PRAY_GEM100 = 637;
    public static final int ACH_FAVOR1 = 638;
    public static final int ACH_SERMON1 = 639;
}
