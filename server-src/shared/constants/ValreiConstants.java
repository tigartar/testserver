...
public class ValreiConstants {
   ...
   public static String getFightActionName(ValreiConstants.ValreiFightAction fightAction) {
   ...
   public static String getFightActionSummary(ValreiConstants.ValreiFightAction fightAction) {
   ...
   public static long getFightActionActor(ValreiConstants.ValreiFightAction fightAction) {
      ByteBuffer bb = ByteBuffer.wrap(fightAction.getActionData());
      return bb.getLong();
   }
