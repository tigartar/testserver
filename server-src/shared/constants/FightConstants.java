...
public interface FightConstants {
    ...
    public static final short CMD_SHOOT = 124;
    public static final short CMD_QUICK_SHOT = 125;
    public static final short CMD_SHOOT_HEAD = 126;
    public static final short CMD_SHOOT_FACE = 127;
    public static final short CMD_SHOOT_TORSO = 128;
    public static final short CMD_SHOOT_LEFTARM = 129;
    public static final short CMD_SHOOT_RIGHTARM = 130;
    public static final short CMD_SHOOT_LEGS = 131;
