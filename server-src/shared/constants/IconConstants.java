...
public final class IconConstants {
    ...
    public static final String[] ICON_SHEET_FILE_NAMES = new String[]{"img.iconsheet.icons", "img.iconsheet.misc", "img.iconsheet.resource", "img.iconsheet.tools", "img.iconsheet.armor", "img.iconsheet.weapons", "img.iconsheet.resource2"};
    ...
    public static final int ICON_CONTAINER_NET_FISH = 885;
    ...
    public static final int ICON_FLOAT_MOSS = 1500;
    ...
    public static final int ICON_DEAD_CLAM = 1499;
    public static final int ICON_WOOD_FISHING_ROD_RACK = 60;
    public static final int ICON_TOOL_FISHING_ROD_OLD = 806;
    public static final int ICON_TOOL_FISHING_FINE_OLD = 786;
    public static final int ICON_JOURNAL = 1456;
    public static final int ICON_BOOK = 1457;
    public static final int ICON_TOKEN = 471;
    public static final int ICON_CAGE_EMPTY = 363;
    public static final int ICON_CAGE_FULL = 364;
    public static final int ICON_CHICKEN_COOP = 403;
    public static final int ICON_CREATURE_HEN = 404;
    public static final int ICON_EMPTY_SLOT_PARENT = 279;
    public static final int ICON_TACKLEBOX_COMPARTMENT = 244;
    public static final int ICON_WOOD_FISH_TROPHY = 626;
    public static final int ICON_LIGHT_BUOY = 245;
    public static final int ICON_DECO_NECKLACE_PEARL = 268;
    public static final int ICON_DECO_GEM_PEARL = 563;

    private IconConstants() {
    }

    public static int getRecipeIconFromName(String iconName) {
        switch (iconName) {
            case "baked apple": {
                return 1445;
            }
