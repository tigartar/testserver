...
public interface Enchants {
    ...
    public static final byte BUFF_ESSENCEDRAIN = 63;
    ...
    public static final byte ITEM_DEBUFF_EXHAUSTION = 95;
    public static final byte ITEM_DEBUFF_VULNERABILITY = 96;
    public static final byte ITEM_DEBUFF_CLUMSINESS = 97;
    public static final byte SHATTERPROT_BUFF = 98;
    public static final byte BUTCHERY_BUFF = 99;
    public static final byte RUNE_MAG_BRASS = -128;
    public static final byte RUNE_MAG_BRONZE = -127;
    public static final byte RUNE_MAG_TIN = -126;
    public static final byte RUNE_MAG_ADAMANTINE = -125;
    public static final byte RUNE_MAG_GLIMMERSTEEL = -124;
    public static final byte RUNE_MAG_GOLD = -123;
    public static final byte RUNE_MAG_SILVER = -122;
    public static final byte RUNE_MAG_STEEL = -121;
    public static final byte RUNE_MAG_COPPER = -120;
    public static final byte RUNE_MAG_IRON = -119;
    public static final byte RUNE_MAG_LEAD = -118;
    public static final byte RUNE_MAG_ZINC = -117;
    public static final byte RUNE_MAG_SERYLL = -116;
    public static final byte RUNE_FO_BRASS = -115;
    public static final byte RUNE_FO_BRONZE = -114;
    public static final byte RUNE_FO_TIN = -113;
    public static final byte RUNE_FO_ADAMANTINE = -112;
    public static final byte RUNE_FO_GLIMMERSTEEL = -111;
    public static final byte RUNE_FO_GOLD = -110;
    public static final byte RUNE_FO_SILVER = -109;
    public static final byte RUNE_FO_STEEL = -108;
    public static final byte RUNE_FO_COPPER = -107;
    public static final byte RUNE_FO_IRON = -106;
    public static final byte RUNE_FO_LEAD = -105;
    public static final byte RUNE_FO_ZINC = -104;
    public static final byte RUNE_FO_SERYLL = -103;
    public static final byte RUNE_VYN_BRASS = -102;
    public static final byte RUNE_VYN_BRONZE = -101;
    public static final byte RUNE_VYN_TIN = -100;
    public static final byte RUNE_VYN_ADAMANTINE = -99;
    public static final byte RUNE_VYN_GLIMMERSTEEL = -98;
    public static final byte RUNE_VYN_GOLD = -97;
    public static final byte RUNE_VYN_SILVER = -96;
    public static final byte RUNE_VYN_STEEL = -95;
    public static final byte RUNE_VYN_COPPER = -94;
    public static final byte RUNE_VYN_IRON = -93;
    public static final byte RUNE_VYN_LEAD = -92;
    public static final byte RUNE_VYN_ZINC = -91;
    public static final byte RUNE_VYN_SERYLL = -90;
    public static final byte RUNE_LIB_BRASS = -89;
    public static final byte RUNE_LIB_BRONZE = -88;
    public static final byte RUNE_LIB_TIN = -87;
    public static final byte RUNE_LIB_ADAMANTINE = -86;
    public static final byte RUNE_LIB_GLIMMERSTEEL = -85;
    public static final byte RUNE_LIB_GOLD = -84;
    public static final byte RUNE_LIB_SILVER = -83;
    public static final byte RUNE_LIB_STEEL = -82;
    public static final byte RUNE_LIB_COPPER = -81;
    public static final byte RUNE_LIB_IRON = -80;
    public static final byte RUNE_LIB_LEAD = -79;
    public static final byte RUNE_LIB_ZINC = -78;
    public static final byte RUNE_LIB_SERYLL = -77;
    public static final byte RUNE_JACKAL_BRASS = -76;
    public static final byte RUNE_JACKAL_BRONZE = -75;
    public static final byte RUNE_JACKAL_TIN = -74;
    public static final byte RUNE_JACKAL_ADAMANTINE = -73;
    public static final byte RUNE_JACKAL_GLIMMERSTEEL = -72;
    public static final byte RUNE_JACKAL_GOLD = -71;
    public static final byte RUNE_JACKAL_SILVER = -70;
    public static final byte RUNE_JACKAL_STEEL = -69;
    public static final byte RUNE_JACKAL_COPPER = -68;
    public static final byte RUNE_JACKAL_IRON = -67;
    public static final byte RUNE_JACKAL_LEAD = -66;
    public static final byte RUNE_JACKAL_ZINC = -65;
    public static final byte RUNE_JACKAL_SERYLL = -64;
    public static final byte RUNE_UNK_BRASS = -63;
    public static final byte RUNE_UNK_BRONZE = -62;
    public static final byte RUNE_UNK_TIN = -61;
    public static final byte RUNE_UNK_ADAMANTINE = -60;
    public static final byte RUNE_UNK_GLIMMERSTEEL = -59;
    public static final byte RUNE_UNK_GOLD = -58;
    public static final byte RUNE_UNK_SILVER = -57;
    public static final byte RUNE_UNK_STEEL = -56;
    public static final byte RUNE_UNK_COPPER = -55;
    public static final byte RUNE_UNK_IRON = -54;
    public static final byte RUNE_UNK_LEAD = -53;
    public static final byte RUNE_UNK_ZINC = -52;
    public static final byte RUNE_UNK_SERYLL = -51;
    public static final byte RUNE_FO_ELECTRUM = -50;
    public static final byte NOID_ENCHANT = -10;
}
