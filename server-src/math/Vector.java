...
public final class Vector {
   ...
   public final Vector transform3(Matrix m) {
      ...
      float[] matrix = m.getMatrix();
      v[0] = (double)(this.vector[0] * matrix[0] + this.vector[1] * matrix[4] + this.vector[2] * matrix[8]);
      v[1] = (double)(this.vector[0] * matrix[1] + this.vector[1] * matrix[5] + this.vector[2] * matrix[9]);
      v[2] = (double)(this.vector[0] * matrix[2] + this.vector[1] * matrix[6] + this.vector[2] * matrix[10]);
   ...
   public final float length() {
      return (float)Math.sqrt((double)(this.vector[0] * this.vector[0] + this.vector[1] * this.vector[1] + this.vector[2] * this.vector[2]));
   }
