...
public final class Matrix {
    ...
    public void setRotationDegrees(float[] angles) {
        float[] vec = new float[]{(float)((double)angles[0] * 180.0 / Math.PI), (float)((double)angles[1] * 180.0 / Math.PI), (float)((double)angles[2] * 180.0 / Math.PI)};
    ...
    public void setScale(float scalX, float scalY, float scalZ) {
        this.matrix[0] = this.matrix[0] * scalX;
        this.matrix[5] = this.matrix[5] * scalY;
        this.matrix[10] = this.matrix[10] * scalZ;
    }
