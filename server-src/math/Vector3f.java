...
public final class Vector3f implements Externalizable, Cloneable {
   ...
   public Vector3f normalizeLocal() {
      float length = this.length();
      return length != 0.0F ? this.divideLocal(length) : this;
   }
   ...
   public int hashCode() {
      ...
      return hash + 37 * hash + Float.floatToIntBits(this.z);
   }
