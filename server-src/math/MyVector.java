...
public final class MyVector {
    ...
    void add(MyVector v) {
        this.mVector[0] = this.mVector[0] + v.mVector[0];
        this.mVector[1] = this.mVector[1] + v.mVector[1];
        this.mVector[2] = this.mVector[2] + v.mVector[2];
        this.mVector[3] = this.mVector[3] + v.mVector[3];
    }

    void normalize() {
        float len = this.length();
        this.mVector[0] = this.mVector[0] / len;
        this.mVector[1] = this.mVector[1] / len;
        this.mVector[2] = this.mVector[2] / len;
    }
